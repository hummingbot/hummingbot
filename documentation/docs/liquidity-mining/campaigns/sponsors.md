...
[0x](https://0x.org/) is an open protocol that enables peer-to-peer exchange of assets on the Ethereum blockchain.

They are sponsoring a campaign for WETH/DAI on [Bamboo Relay](https://bamboorelay.com/), a decentralized crypto exchange built on 0x protocol. Users can trade, lend or borrow any ERC20 token trustlessly from their own wallet.

[Twitter](https://twitter.com/0xproject) | [Discord](https://discord.gg/d3FTX3M) | [CoinMarketCap](https://coinmarketcap.com/currencies/0x/) | [CoinGecko](https://www.coingecko.com/en/coins/0x)
