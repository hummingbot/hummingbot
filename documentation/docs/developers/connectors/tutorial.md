...
i.e. in this mode all the tests should pass without using real exchange API credentials.<br/>
    ...
    - Create environment variables <br/>
      ...
      `XXX_API_KEY` - string - the exchange API key (replace XXX with your exchage name) <br/>
      `XXX_API_SECRET` - string - the exchange API secret <br/>
