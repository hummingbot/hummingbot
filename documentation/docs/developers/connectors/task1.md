...
`get_mid_price` | trading_pair: `str` | `Decimal` | Calculate and return the average of the best bid and best ask prices from the exchange's ticker endpoint i.e `(best_bid + best_ask) / 2`
