...
As the Get Order Book strategy extends the Hello World strategy, several new sections of code are introduced. Specifically, a section of code is added in the format_status function which checks if there are any open orders. 
