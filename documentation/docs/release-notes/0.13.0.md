...
* Developer documentation for [cross exchange market making](/developers/strategies/)
...
For more details, see here: [trading strategy autostart](/global-configs/strategy-autostart/).
