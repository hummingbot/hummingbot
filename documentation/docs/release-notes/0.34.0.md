...
Read more in our documentation how to use the connector [here](/exchanges/terra).

!!! warning
    Currently [dydx](/exchanges/dydx/), [terra](/exchanges/terra) and [loopring](/exchanges/loopring/) don't work on Binary Installers. It can only be used when running Hummingbot from source or with Docker.
