...
See the new [Parameters](/parameters/) section to learn more about how these features work. We have described the main changes below.
...
More information can be found in our documentation for [Inventory Skew](/parameters/inventory-skew/) with sample scenarios.
...
Read through [Hanging Orders](/parameters/hanging-orders/) in our documentation for more information.
