...
🚀Welcome to `hummingbot` version 0.15.0! This release is full of strategy improvements as well as a new major feature: paper trading mode.
...
We have implemented some pure market making strategy improved suggested and reviewed by a large crypto hedge fund, around optimizing for when to replenish and place orders once an existing order has been filled:
