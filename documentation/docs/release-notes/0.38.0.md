...
Read more about how to use the DigiFinex connector [here](/connectors/digifinex/).
...
Read more about how to use the HitBTC connector [here](/connectors/hitbtc/).
...
Read more about how to use the CoinZoom connector [here](/connectors/coinzoom/).
...
Learn more about it [here](/connectors/ascend-ex/)
...
Learn more about the feature [here](/operation/rate-oracle/).
