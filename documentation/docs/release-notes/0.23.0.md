...
The open beta testing for our liquidity mining program launches today! During the 4-week beta, we will conduct a series of user tests to collect feedback so that we can make the UX as good as possible before we go live.

Users can participate in the testing by filling out this [form](https://docs.google.com/forms/u/1/d/e/1FAIpQLSfw9XOv_xAi2IqTmjsebJhjAIa6vewS0wFS0j4TsxeDRbsm5Q/viewform?usp=send_form). Testers will receive 0.1 ETH for their time.
