...
## 🤖 Dynamic Bot Controls

The scripts feature is a Python fucntion that allows the user to automate commands if certain conditions are met. Currently, this feature can only be used when running Hummingbot from source or with Docker.

Read more about the scripts feature in the [Advanced](https://docs.hummingbot.io/advanced/scripts/) section in the documentation.


## 🔗 New Eterbase connector

Hummingbot now supports [Eterbase](https://www.eterbase.com/) exchange! Eterbase is the first regulation-complient European cryptocurrency exchange, offering fast, secure trading on a clean, powerful, user interface.

Read more about how to use Eterbase connector [here](/connectors/eterbase/).
