...
* Added instructions in [Common ‘How To’ Questions](https://docs.hummingbot.io/support/questions/) on how to locate the data file in Hummingbot installed via binary, checking status of multiple bots simultaneously, adding paper trade balance from inside the client, refresh Hummingbot window pane.
