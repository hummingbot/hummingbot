...
* Added a [fix (#1868)](https://github.com/CoinAlpha/hummingbot/pull/1869) for an [enhancement (#1669)](https:/8/github.com/CoinAlpha/hummingbot/issues/1669) to enter negative values for the `order_level_amount` parameter.
