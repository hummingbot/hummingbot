...
The error is caused by a previous `json` file that saves your hummingbot authentication. This file was not removed completely or was imported back to the hummingbot config folder. To prevent this error, you will have to reset the hummingbot password using the instructions below.
