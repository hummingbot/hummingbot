...
| [External Price Source](./price-source) | `take_if_crossed` | `Do you want to take the best order if orders cross the orderbook?` | Take order if they cross orderbook when external price source is enabled. |
