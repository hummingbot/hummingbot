...
!!! info
      This strategy only works with [Binance Futures](connectors/binance-futures/), [Perpetual Finance (BETA)](connectors/perp-fi/) & [dYdX Perpetual(BETA)](connectors/dydx-perpetual/)
...
!!! tip
      ...
      - [Creating Binance Futures Testnet API Keys](https://docs.hummingbot.io/connectors/binance-futures/#creating-binance-futures-testnet-api-keys)
