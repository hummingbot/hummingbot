...
6. Fix any changes requested by your reviewer, fix issues raised by the tester, and push your fixes as a single new commit.
...
- If you want to explain the commit in more depth, following the first line should be a blank line and a more detailed description of the commit. This can be as detailed as you want, so dig into details here and keep the first line short.
...
This will start the rebase process. It would be best if you committed all of your changes before doing this. If there are no conflicts, this should roll all of your changes back on top of the changes from upstream, leading to a nice, clean, linear commit history.
