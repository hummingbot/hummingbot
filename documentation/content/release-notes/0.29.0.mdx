...
🚀 Welcome to `hummingbot` version 0.29.0! This release introduces a new feature that allows users to run custom scripts, a new advanced pure market-making parameter, a new connector, and bug fixes.
