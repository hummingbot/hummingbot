...
On Friday, August 23, IDEX released updates to its servers requiring authentication/use of API keys to access its APIs. For more information, see the IDEX API key.
...
- Fix the "fatal Not a git repository" warning bug when operating Hummingbot with Docker.
