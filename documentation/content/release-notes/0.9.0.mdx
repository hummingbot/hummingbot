...
The [pure market making strategy](/strategies/pure-market-making/) now allows you to place multiple levels of orders on each side of the order book. This enables market makers to set different tiers of orders with various spreads and order amounts.

Please see the [Multiple Orders configuration](/strategies/order-levels/) section for information on how to use this new feature.
...
- `status` command now stops duplicate printing output
- Fixed a bug that causes exchange rate conversion issues when running the cross-exchange market-making strategy between DDEX and IDEX [#386](https://github.com/CoinAlpha/hummingbot/issues/386)
- Fixed a bug that prevented running the arbitrage and cross-exchange strategies one exchange [#401](https://github.com/CoinAlpha/hummingbot/issues/401)
...
- Fixed an error that stopped the cross-exchange market making strategy after one trade on Binance [#427](https://github.com/CoinAlpha/hummingbot/issues/427)
