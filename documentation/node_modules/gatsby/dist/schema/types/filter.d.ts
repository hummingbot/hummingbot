import { InputTypeComposer, SchemaComposer, ObjectTypeComposer, InterfaceTypeComposer } from "graphql-compose";
...
export declare const getFilterInput: ({ schemaComposer, typeComposer, }: {
