...
exports.componentDataDependenciesReducer = void 0;

const componentDataDependenciesReducer = (state = {
  nodes: new Map(),
  connections: new Map()
}, action) => {
  switch (action.type) {
...
exports.componentDataDependenciesReducer = componentDataDependenciesReducer;
