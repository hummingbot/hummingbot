...
export default function createOrganizationApi({ http }: {
     ...
     * ```
     */
    getOrganizationMembership(id: string): Promise<import("./entities/organization-membership").OrganizationMembership>;
    /**
     ...
     * ```
     */
    getOrganizationMemberships(query?: QueryOptions): Promise<import("./common-types").Collection<import("./entities/organization-membership").OrganizationMembership, import("./entities/organization-membership").OrganizationMembershipProps>>;
    /**
     * Creates a Team
     ...
     * ```
     */
    getOrganizationSpaceMembership(id: string): Promise<import("./entities/space-membership").SpaceMembership>;
    /**
     ...
     * ```
     */
    getOrganizationSpaceMemberships(query?: QueryOptions): Promise<import("./common-types").Collection<import("./entities/space-membership").SpaceMembership, import("./entities/space-membership").SpaceMembershipProps>>;
    /**
     ...
     * ```
     */
    createOrganizationInvitation(data: Omit<OrganizationInvitationProps, 'sys'>): Promise<import("./entities/organization-invitation").OrganizationInvitation>;
    /**
     ...
     * ```
     */
    createAppDefinition(data: Omit<AppDefinitionProps, 'sys'>): Promise<import("./entities/app-definition").AppDefinition>;
    /**
     ...
     * ```
     */
    getAppDefinitions(query?: QueryOptions): Promise<import("./common-types").Collection<import("./entities/app-definition").AppDefinition, AppDefinitionProps>>;
    /**
