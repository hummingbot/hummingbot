...
const enoent = __webpack_require__(554);
...
const btoa = __webpack_require__(946);
...
const { Deprecation } = __webpack_require__(597)
...
const rest_1 = __importDefault(__webpack_require__(896));
...
const escape = __webpack_require__(225);
const readShebang = __webpack_require__(960);
...
const isStream = __webpack_require__(524);
const _getStream = __webpack_require__(908);
...
var getUserAgent = _interopDefault(__webpack_require__(696));
var isPlainObject = _interopDefault(__webpack_require__(154));
var nodeFetch = _interopDefault(__webpack_require__(497));
...
var endpoint = __webpack_require__(754);
var getUserAgent = _interopDefault(__webpack_require__(444));
var isPlainObject = _interopDefault(__webpack_require__(154));
...
var deepmerge = _interopDefault(__webpack_require__(114));
var isPlainObject = _interopDefault(__webpack_require__(154));
var urlTemplate = _interopDefault(__webpack_require__(595));
var getUserAgent = _interopDefault(__webpack_require__(578));
...
module.exports = {"_args":[["@octokit/rest@16.28.1","/Users/justin/projects/apollo/space-kit"]],"_development":true,"_from":"@octokit/rest@16.28.1","_id":"@octokit/rest@16.28.1","_inBundle":false,"_integrity":"sha512-9H/5F0f2bSVhk78ypu/A9dkK5GCH/aI8CxRJ0L8JU/XEYNIYozxqD6HVC7shsofrCfR61YORfjTE+GxfZ/wasQ==","_location":"/@octokit/rest","_phantomChildren":{"@octokit/endpoint":"5.3.2","@octokit/request-error":"1.0.4","deprecation":"2.3.1","is-plain-object":"3.0.0","once":"1.4.0","universal-user-agent":"2.1.0"},"_requested":{"type":"version","registry":true,"raw":"@octokit/rest@16.28.1","name":"@octokit/rest","escapedName":"@octokit%2frest","scope":"@octokit","rawSpec":"16.28.1","saveSpec":null,"fetchSpec":"16.28.1"},"_requiredBy":["/@actions/github","/@auto-it/core"],"_resolved":"https://registry.npmjs.org/@octokit/rest/-/rest-16.28.1.tgz","_spec":"16.28.1","_where":"/Users/justin/projects/apollo/space-kit","author":{"name":"Gregor Martynus","url":"https://github.com/gr2m"},"bugs":{"url":"https://github.com/octokit/rest.js/issues"},"bundlesize":[{"path":"./dist/octokit-rest.min.js.gz","maxSize":"33 kB"}],"contributors":[{"name":"Mike de Boer","email":"info@mikedeboer.nl"},{"name":"Fabian Jakobs","email":"fabian@c9.io"},{"name":"Joe Gallo","email":"joe@brassafrax.com"},{"name":"Gregor Martynus","url":"https://github.com/gr2m"}],"dependencies":{"@octokit/request":"^4.0.1","@octokit/request-error":"^1.0.2","atob-lite":"^2.0.0","before-after-hook":"^1.4.0","btoa-lite":"^1.0.0","deprecation":"^2.0.0","lodash.get":"^4.4.2","lodash.set":"^4.3.2","lodash.uniq":"^4.5.0","octokit-pagination-methods":"^1.1.0","once":"^1.4.0","universal-user-agent":"^2.0.0","url-template":"^2.0.8"},"description":"GitHub REST API client for Node.js","devDependencies":{"@gimenete/type-writer":"^0.1.3","@octokit/fixtures-server":"^5.0.1","@octokit/routes":"20.6.1","@types/node":"^12.0.0","bundlesize":"^0.17.0","chai":"^4.1.2","compression-webpack-plugin":"^3.0.0","coveralls":"^3.0.0","glob":"^7.1.2","http-proxy-agent":"^2.1.0","lodash.camelcase":"^4.3.0","lodash.merge":"^4.6.1","lodash.upperfirst":"^4.3.1","mkdirp":"^0.5.1","mocha":"^6.0.0","mustache":"^3.0.0","nock":"^10.0.0","npm-run-all":"^4.1.2","nyc":"^14.0.0","prettier":"^1.14.2","proxy":"^0.2.4","semantic-release":"^15.0.0","sinon":"^7.2.4","sinon-chai":"^3.0.0","sort-keys":"^3.0.0","standard":"^12.0.0","string-to-arraybuffer":"^1.0.0","string-to-jsdoc-comment":"^1.0.0","typescript":"^3.3.1","webpack":"^4.0.0","webpack-bundle-analyzer":"^3.0.0","webpack-cli":"^3.0.0"},"files":["index.js","index.d.ts","lib","plugins"],"homepage":"https://github.com/octokit/rest.js#readme","keywords":["octokit","github","rest","api-client"],"license":"MIT","name":"@octokit/rest","nyc":{"ignore":["test"]},"publishConfig":{"access":"public"},"release":{"publish":["@semantic-release/npm",{"path":"@semantic-release/github","assets":["dist/*","!dist/*.map.gz"]}]},"repository":{"type":"git","url":"git+https://github.com/octokit/rest.js.git"},"scripts":{"build":"npm-run-all build:*","build:browser":"npm-run-all build:browser:*","build:browser:development":"webpack --mode development --entry . --output-library=Octokit --output=./dist/octokit-rest.js --profile --json > dist/bundle-stats.json","build:browser:production":"webpack --mode production --entry . --plugin=compression-webpack-plugin --output-library=Octokit --output-path=./dist --output-filename=octokit-rest.min.js --devtool source-map","build:ts":"node scripts/generate-types","coverage":"nyc report --reporter=html && open coverage/index.html","generate-bundle-report":"webpack-bundle-analyzer dist/bundle-stats.json --mode=static --no-open --report dist/bundle-report.html","generate-routes":"node scripts/generate-routes","postvalidate:ts":"tsc --noEmit --target es6 test/typescript-validate.ts","prebuild:browser":"mkdirp dist/","pretest":"standard","prevalidate:ts":"npm run -s build:ts","start-fixtures-server":"octokit-fixtures-server","test":"nyc mocha test/mocha-node-setup.js \"test/*/**/*-test.js\"","test:browser":"cypress run --browser chrome","test:memory":"mocha test/memory-test","validate:ts":"tsc --target es6 --noImplicitAny index.d.ts"},"standard":{"globals":["describe","before","beforeEach","afterEach","after","it","expect","cy"],"ignore":["/docs"]},"types":"index.d.ts","version":"16.28.1"};
...
const bufferStream = __webpack_require__(697);
...
const version = __webpack_require__(593).version
