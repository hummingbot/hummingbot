...
exports.pluginOptionsSchema = function (_ref2) {
  ...
  return Joi.object({
    ...
    autoLabel: Joi.boolean().default(process.env.NODE_ENV !== "production").description("This option automatically adds the label property to styles so that class names generated by css or styled include the name of the variable the result is assigned to. You can read more about this option in babel-plugin-emotion's docs: https://emotion.sh/docs/babel-plugin-emotion#autolabel"),
    ...
    cssPropOptimization: Joi.boolean().default(true).description("This option assumes that you are using something to make @emotion/core\u2019s jsx function work for all jsx. If you are not doing so and you do not want such optimizations to occur, disable this option.")
  });
};