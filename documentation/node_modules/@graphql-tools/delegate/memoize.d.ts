...
export declare function memoize2of3<T1 extends Record<string, any>, T2 extends Record<string, any>, T3 extends any, R extends any>(fn: (A1: T1, A2: T2, A3: T3) => R): (A1: T1, A2: T2, A3: T3) => R;
