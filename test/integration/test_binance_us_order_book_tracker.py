...
from hummingbot.connector.exchange.binance_us.binance_us_order_book_tracker import BinanceUsOrderBookTracker
...
class BinanceUsOrderBookTrackerUnitTest(unittest.TestCase):

    order_book_tracker: Optional[BinanceUsOrderBookTracker] = None
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: BinanceUsOrderBookTracker = BinanceUsOrderBookTracker(
    ...
    def test_api_get_last_traded_prices(self):
        prices = self.ev_loop.run_until_complete(
            BinanceUsAPIOrderBookDataSource.get_last_traded_prices(["BTCUSDT", "LTCBTC"]))
