...
class TestLiquidOrderBookDataSource(TestCase):
    ...
    def test_get_tracking_pairs(self, mock_get_trading_pairs, mock_get_snapshot):
        ...
        {
            'BTCUSD': OrderBookTrackerEntry(symbol = 'BTCUSD', timestamp = '1573021425.445617', order_book = '<hummingbot.core.data_type.order_book.OrderBook object at 0x11fa72328>'),
            'ETHUSDC': OrderBookTrackerEntry(symbol = 'ETHUSDC', timestamp = '1573021426.4484851', order_book = '<hummingbot.core.data_type.order_book.OrderBook object at 0x11fa723c0>'),
            'BTCUSDC': OrderBookTrackerEntry(symbol = 'BTCUSDC', timestamp = '1573021427.4509811', order_book = '<hummingbot.core.data_type.order_book.OrderBook object at 0x11fa72458>')
        }
        """
        loop = asyncio.get_event_loop()
