...
class VeridexOrderBookTrackerUnitTest(unittest.TestCase):
    order_book_tracker: Optional[VeridexOrderBookTracker] = None
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: VeridexOrderBookTracker = VeridexOrderBookTracker(
