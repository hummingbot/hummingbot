class FixtureBinance:
    ...
    # General User Info
    BALANCES = {"makerCommission": 10, "takerCommission": 10, "buyerCommission": 0, "sellerCommission": 0,
    ...
    TRADE_FEES = {"tradeFee": [{"symbol": "LINKBTC", "maker": 0.0010, "taker": 0.0010},
    ...
    # User Trade Info
    BUY_MARKET_ORDER = {"symbol": "LINKETH", "orderId": 153849723, "orderListId": -1,
    ...
    SELL_MARKET_ORDER = {"symbol": "LINKETH", "orderId": 153849728, "orderListId": -1,
    ...
    OPEN_BUY_ORDER = {"symbol": "LINKETH", "orderId": 154316832, "orderListId": -1,
    ...
    OPEN_SELL_ORDER = {"symbol": "LINKETH", "orderId": 154316831, "orderListId": -1,
