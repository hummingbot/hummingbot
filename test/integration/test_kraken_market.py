...
class KrakenMarketUnitTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.market: KrakenMarket = KrakenMarket(
            "hPvraToXEWaxtP6dJME7kr5yZf72IHc7ivQUbCUXv4iWI6MZ3yYu3Vg0",
            "VH3QJV8TMQAEOxxLZT4CYKNYxgMhq7JwVhvNriUFFrH0AlQ57nCDAJS8EB04+b4siu0gX8v/N7JUYAl7mv4l8Q==",
            symbols=["XBT/USD"]
        )
        # Need 2nd instance of market to prevent events mixing up across tests
        cls.market_2: KrakenMarket = KrakenMarket(
            "hPvraToXEWaxtP6dJME7kr5yZf72IHc7ivQUbCUXv4iWI6MZ3yYu3Vg0",
            "VH3QJV8TMQAEOxxLZT4CYKNYxgMhq7JwVhvNriUFFrH0AlQ57nCDAJS8EB04+b4siu0gX8v/N7JUYAl7mv4l8Q==",
            symbols=["XBT/USD"]
        )
    ...
    def test_get_fee(self):
        limit_fee: TradeFee = self.market.get_fee("XBT", "USD", OrderType.LIMIT, TradeType.BUY, 1, 10)
        self.assertGreater(limit_fee.percent, 0)
        self.assertEqual(len(limit_fee.flat_fees), 0)
        market_fee: TradeFee = self.market.get_fee("XBT", "USD", OrderType.MARKET, TradeType.BUY, 1)
        self.assertGreater(market_fee.percent, 0)
        self.assertEqual(len(market_fee.flat_fees), 0)
        sell_trade_fee: TradeFee = self.market.get_fee("XBT", "USD", OrderType.LIMIT, TradeType.SELL, 1, 10)
        self.assertGreater(sell_trade_fee.percent, 0)
        self.assertEqual(len(sell_trade_fee.flat_fees), 0)

    def test_limit_buy(self):
        symbol = "XBT/USD"
        amount: Decimal = Decimal("0.0021")
        ...
        self.assertEqual("XBT", order_completed_event.base_asset)
    ...
    def test_market_buy(self):
        ...
        self.assertEqual("XBT", buy_order_completed_event.base_asset)
    ...
    def test_market_sell(self):
        ...
        self.assertEqual("XBT", sell_order_completed_event.base_asset)
    ...
    def test_cancel_order(self):
        ...
        quantize_bid_price: Decimal = self.market.quantize_order_price(symbol, bid_price)
        quantized_amount: Decimal = self.market.quantize_order_amount(symbol, amount)
        client_order_id = self.market.sell(symbol, quantized_amount, OrderType.LIMIT, quantize_bid_price)
    ...
    def test_orders_saving_and_restoration(self):
        ...
        try:
            ...
            # Try to put limit buy order for 0.04 XBT, and watch for order creation event.
            current_bid_price: Decimal = self.market.get_price(symbol, True)
            ...
            self.market: KrakenMarket = KrakenMarket(
                kraken_api_key="hPvraToXEWaxtP6dJME7kr5yZf72IHc7ivQUbCUXv4iWI6MZ3yYu3Vg0",
                kraken_secret_key="VH3QJV8TMQAEOxxLZT4CYKNYxgMhq7JwVhvNriUFFrH0AlQ57nCDAJS8EB04+b4siu0gX8v/N7JUYAl7mv4l8Q==",
                symbols=["ETH/USD", "XBT/USD"]
            )
            for event_tag in self.events:
                self.market.add_listener(event_tag, self.market_logger)
            recorder.stop()
    ...
    def test_order_fill_record(self):
        ...
        try:
            # Try to buy 0.002 XBT from the exchange, and watch for completion event.
            amount: Decimal = Decimal("0.002")
            ...
            # Try to sell back the same amount of XBT to the exchange, and watch for completion event.
