...
class BeaxyOrderBookTrackerUnitTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: BeaxyOrderBookTracker = BeaxyOrderBookTracker(
    ...
    def test_tracker_integrity(self):
        ...
        test_order_book: OrderBook = order_books["BTCUSDC"]
        ...
        test_active_order_tracker = self.order_book_tracker._active_order_trackers["BTCUSDC"]
