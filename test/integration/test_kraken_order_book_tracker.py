...
class KrakenOrderBookTrackerUnitTest(unittest.TestCase):
    order_book_tracker: Optional[KrakenOrderBookTracker] = None
    ...
    def test_tracker_integrity(self):
        ...
        xbtusd_book: OrderBook = order_books["XBT/USD"]
        xrpusdt_book: OrderBook = order_books["XRP/USD"]
        # print(xbtusd_book.snapshot)
        # print(xrpusdt_book.snapshot)
        self.assertGreaterEqual(xbtusd_book.get_price_for_volume(True, 10).result_price,
                                xbtusd_book.get_price(True))
        self.assertLessEqual(xbtusd_book.get_price_for_volume(False, 10).result_price,
                             xbtusd_book.get_price(False))
