...
class KyberOrderBookTrackerUnitTest(unittest.TestCase):
    ...
    #todo: change trading pair to ETH-KNC format
    trading_pairs: List[str] = ["ETH_KNC"]
    ...
    def test_tracker_integrity(self):
        ...
        eth_knc_book: OrderBook = order_books["ETH_KNC"]
        print(eth_knc_book.get_price_for_volume(True, 10).result_price)
        self.assertGreaterEqual(eth_knc_book.get_price_for_volume(True, 10).result_price,
                                eth_knc_book.get_price(True))
        self.assertLessEqual(eth_knc_book.get_price_for_volume(False, 10).result_price,
                             eth_knc_book.get_price(False))
