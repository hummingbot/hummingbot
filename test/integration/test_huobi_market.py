...
class HuobiMarketUnitTest(unittest.TestCase):
    ...
    def test_cancel_order(self):
        ...
        current_bid_price: float = self.market.get_price(symbol, True)
        amount: float = 0.1 / current_bid_price
    ...
    def test_withdraw(self):
        ...
        self.assertGreaterEqual(self.market.get_balance("eth"), 0.1)

        # Withdraw ZRX from Coinbase Pro to test wallet.
        self.market.withdraw(self.wallet.address, "eth", 0.1)
        ...
        self.assertEqual("eth", withdraw_asset_event.asset_name)
        self.assertEqual(0.1, withdraw_asset_event.amount)
