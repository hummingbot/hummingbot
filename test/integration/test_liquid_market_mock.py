...
class LiquidMarketMockUnitTest(unittest.TestCase):
    ...
    @mock_aiohttp([('api.liquid.com', '/products', 'get', PASSTHROUGH),
                   ...
                   ('api.liquid.com', '/crypto_accounts', 'get', FixtureLiquid.CRYTO_ACCOUNTS),
    ...
    def setUpClass(cls):
        ...
        cls.ev_loop.run_until_complete(cls.market._api_request('GET', url='https://api.liquid.com/products'))
        print("Ready.")
