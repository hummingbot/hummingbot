...
class BinanceMarketUnitTest(unittest.TestCase):
    ...
    def test_trade_fees_config(self):
        trade_fees_config_map["binance_taker_fee"].value = None
        ...
        trade_fees_config_map["binance_taker_fee"].value = Decimal('0.002')
        taker_fee: TradeFee = self.market.get_fee("LINK", "ETH", OrderType.MARKET, TradeType.BUY, Decimal(1),
                                                  Decimal('0.1'))
        self.assertAlmostEqual(Decimal("0.002"), taker_fee.percent)
        trade_fees_config_map["binance_maker_fee"].value = None
        ...
        trade_fees_config_map["binance_maker_fee"].value = Decimal('0.005')
        maker_fee: TradeFee = self.market.get_fee("LINK", "ETH", OrderType.MARKET, TradeType.BUY, Decimal(1),
                                                  Decimal('0.1'))
