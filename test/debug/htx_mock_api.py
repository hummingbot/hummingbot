...
class HtxMockAPI:
    MOCK_HTX_USER_ID = 10000000
    MOCK_HTX_LIMIT_BUY_ORDER_ID = 11111
    MOCK_HTX_LIMIT_SELL_ORDER_ID = 22222
    MOCK_HTX_MARKET_BUY_ORDER_ID = 33333
    MOCK_HTX_MARKET_SELL_ORDER_ID = 44444
    MOCK_HTX_LIMIT_CANCEL_ORDER_ID = 55555
    MOCK_HTX_LIMIT_OPEN_ORDER_ID = 66666
    MOCK_HTX_LIMIT_BUY_RESPONSE = {
        "status": "ok",
        "data": {
            "id": MOCK_HTX_LIMIT_BUY_ORDER_ID,
            "symbol": "ethusdt",
            "account-id": 10055506,
            ...
            "user-id": MOCK_HTX_USER_ID,
            "source": "spot-api",
            "state": "filled",
            "canceled-at": 0
        }
    }
    MOCK_HTX_LIMIT_SELL_RESPONSE = {
        "status": "ok",
        "data": {
            "id": MOCK_HTX_LIMIT_SELL_ORDER_ID,
            "symbol": "ethusdt",
            "account-id": 10055506,
            "amount": "0.020000000000000000",
            "price": "189.770000000000000000",
    ...
    MOCK_HTX_MARKET_SELL_RESPONSE = {
        "status": "ok",
        "data": {
            "id": MOCK_HTX_MARKET_SELL_ORDER_ID,
            "symbol": "ethusdt",
            "account-id": 10055506,
            "amount": "0.020000000000000000",
            "price": "0.0",
    ...
    MOCK_HTX_LIMIT_CANCEL_RESPONSE = {
        "status": "ok",
        "data": {
            "id": MOCK_HTX_LIMIT_CANCEL_ORDER_ID,
            "symbol": "ethusdt",
            "account-id": 10055506,
            "amount": "0.020000000000000000",
    ...
    MOCK_HTX_LIMIT_OPEN_RESPONSE = {
        "status": "ok",
        "data": {
            "id": MOCK_HTX_LIMIT_OPEN_ORDER_ID,
            "symbol": "ethusdt",
            "account-id": 10055506,
    ...
    def __init__(self):
        ...
        self.order_response_dict = {
            self.MOCK_HTX_LIMIT_BUY_ORDER_ID: self.MOCK_HTX_LIMIT_BUY_RESPONSE,
            self.MOCK_HTX_LIMIT_SELL_ORDER_ID: self.MOCK_HTX_LIMIT_SELL_RESPONSE,
            self.MOCK_HTX_MARKET_BUY_ORDER_ID: self.MOCK_HTX_MARKET_BUY_RESPONSE,
            self.MOCK_HTX_MARKET_SELL_ORDER_ID: self.MOCK_HTX_MARKET_SELL_RESPONSE,
            self.MOCK_HTX_LIMIT_CANCEL_ORDER_ID: self.MOCK_HTX_LIMIT_CANCEL_RESPONSE,
            self.MOCK_HTX_LIMIT_OPEN_ORDER_ID: self.MOCK_HTX_LIMIT_OPEN_RESPONSE
        }
