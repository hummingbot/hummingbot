...
class BitcoinRDExchangeUnitTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.connector: BitcoinRDExchange = BitcoinRDExchange(
            bitcoin_rd_api_key=API_KEY,
            bitcoin_rd_secret_key=API_SECRET,
            trading_pairs=[cls.trading_pair],
            trading_required=True
        )
        print("Initializing BitcoinRD exchange... this will take about a minute.")
    ...
    def test_orders_saving_and_restoration(self):
        ...
        try:
            ...
            for event_tag in self.events:
                self.connector.remove_listener(event_tag, self.event_logger)
            new_connector = BitcoinRDExchange(API_KEY, API_SECRET, [self.trading_pair], True)
            for event_tag in self.events:
