...
from hummingbot.connector.exchange.bitcoin_rd.bitcoin_rd_order_book_tracker import BitcoinRDOrderBookTracker
...
class BitcoinRDOrderBookTrackerUnitTest(unittest.TestCase):
    order_book_tracker: Optional[BitcoinRDOrderBookTracker] = None
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: BitcoinRDOrderBookTracker = BitcoinRDOrderBookTracker(cls.throttler, cls.trading_pairs)
    ...
    def test_api_get_last_traded_prices(self):
        prices = self.ev_loop.run_until_complete(
            BitcoinRDAPIOrderBookDataSource.get_last_traded_prices(["BTC-USDT", "LTC-BTC"]))
