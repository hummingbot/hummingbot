...
class LatokenOrderBookTrackerUnitTest(unittest.TestCase):
    order_book_tracker: Optional[LatokenOrderBookTracker] = None
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: LatokenOrderBookTracker = LatokenOrderBookTracker(trading_pairs=cls.trading_pairs)
