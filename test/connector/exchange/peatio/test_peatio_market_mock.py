...
from test.debug.peatio_mock_api import PeatioMockAPI


logging.basicConfig(level=METRICS_LOG_LEVEL)
MOCK_PEATIO_ACCESS_KEY = "zzzzzzzzzz-xxxxxxxx-55555555-xxxxx"
MOCK_PEATIO_SECRET_KEY = "11111111-aaaaaaaa-22222222-bbbbb"


class PeatioMarketUnitTest(AioHTTPTestCase):
    ...
    async def get_application(self):
        app = web.Application()
        self.mock_api = PeatioMockAPI()
        app.router.add_get("/mockSnapshot", self.mock_api.get_mock_snapshot)
        app.router.add_get("/api/v2/peatio/public/markets/tickers", self.mock_api.get_market_tickers)
        app.router.add_get("/api/v2/peatio/public/timestamp", self.mock_api.get_common_timestamp)
        app.router.add_get("/api/v2/peatio/public/markets", self.mock_api.get_common_symbols)
        app.router.add_get("/api/v2/peatio/account/balances", self.mock_api.get_user_balance)
        app.router.add_post("/api/v2/peatio/market/orders", self.mock_api.post_order_place)
    ...
    def customSetUp(self):
        self.market: PeatioExchange = PeatioExchange(
            peatio_access_key=MOCK_PEATIO_ACCESS_KEY,
            peatio_secret_key=MOCK_PEATIO_SECRET_KEY,
            trading_pairs=["eth_usdterc20"]
        )
        ...
        # mock_data_source: MockAPIOrderBookDataSource = MockAPIOrderBookDataSource(self.client, PeatioOrderBook, ["eth_usdterc20"])
    ...
    def test_market_buy(self):
        self.customSetUp()
        trading_pair = "eth_usdterc20"
        price: Decimal = self.market.get_price(trading_pair, True)
        amount: Decimal = Decimal(0.02)
        quantized_amount: Decimal = self.market.quantize_order_amount(trading_pair, amount)

        self.mock_api.order_id = self.mock_api.MOCK_PEATIO_MARKET_BUY_ORDER_ID
        self.mock_api.order_side = self.mock_api.MOCK_PEATIO_MARKET_BUY_ORDER_SIDE
        self.mock_api.order_type = self.mock_api.MOCK_PEATIO_MARKET_BUY_ORDER_TYPE
        self.mock_api.order_market = trading_pair
        self.mock_api.order_price = str(price)
        self.mock_api.order_volume = str(quantized_amount)
    ...
    def test_market_sell(self):
        ...
        self.mock_api.order_id = self.mock_api.MOCK_PEATIO_MARKET_SELL_ORDER_ID
        self.mock_api.order_side = self.mock_api.MOCK_PEATIO_MARKET_SELL_ORDER_SIDE
        self.mock_api.order_type = self.mock_api.MOCK_PEATIO_MARKET_SELL_ORDER_TYPE
        self.mock_api.order_market = trading_pair
        self.mock_api.order_price = str(price)
        self.mock_api.order_volume = str(quantized_amount)
    ...
    def test_cancel_order(self):
        self.customSetUp()
        self.mock_api.order_id = self.mock_api.MOCK_PEATIO_LIMIT_CANCEL_ORDER_ID
        trading_pair = "eth_usdterc20"
        ...
        self.mock_api.order_response_dict[self.mock_api.MOCK_PEATIO_LIMIT_CANCEL_ORDER_ID]["data"]["state"] = "canceled"
    ...
    def test_cancel_all(self):
        ...
        self.mock_api.cancel_all_order_ids = [
            self.mock_api.MOCK_PEATIO_LIMIT_BUY_ORDER_ID,
            self.mock_api.MOCK_PEATIO_LIMIT_SELL_ORDER_ID,
        ]
        trading_pair = "eth_usdterc20"
        ...
        self.mock_api.order_id = self.mock_api.MOCK_PEATIO_LIMIT_BUY_ORDER_ID
        self.market.buy(trading_pair, quantized_amount, OrderType.LIMIT_MAKER, quantize_bid_price)
        self.mock_api.order_id = self.mock_api.MOCK_PEATIO_LIMIT_SELL_ORDER_ID
    ...
    def test_orders_saving_and_restoration(self):
        ...
        trading_pair: str = "eth_usdterc20"
        ...
        try:
            ...
            self.mock_api.order_id = self.mock_api.MOCK_PEATIO_LIMIT_OPEN_ORDER_ID
            ...
            self.market: PeatioExchange = PeatioExchange(
                peatio_access_key=MOCK_PEATIO_ACCESS_KEY,
                peatio_secret_key=MOCK_PEATIO_SECRET_KEY,
                trading_pairs=["eth_usdterc20", "btc_usdterc20"]
            )
            self.market.shared_client: TestClient = self.client
            mock_data_source: MockAPIOrderBookDataSource = MockAPIOrderBookDataSource(self.client, PeatioOrderBook, ["eth_usdterc20"])
            self.market.order_book_tracker.data_source = mock_data_source
            ...
            self.mock_api.order_id = self.mock_api.MOCK_PEATIO_LIMIT_OPEN_ORDER_ID
            self.mock_api.order_response_dict[self.mock_api.MOCK_PEATIO_LIMIT_OPEN_ORDER_ID]["data"]["state"] = "canceled"
