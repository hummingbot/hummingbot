class Fixturesouthxchange:
    TRADES = [{"At":1633016333,"Amount":0.99,"Price":93.6,"Type":"buy"},{"At":1633016259,"Amount":1.0,"Price":92.0,"Type":"sell"}]

    FEES = {"Currencies":[{"Code":"BTC","Name":"Bitcoin","Precision":8,"MinDeposit":0.0,"DepositFeeMin":0.0,"MinWithdraw":0.1,"WithdrawFee":0.001,"WithdrawFeeMin":0.01},   
    ...
    "Markets":[{"ListingCurrencyCode":"LTC2","ReferenceCurrencyCode":"BTC2","MakerFee":0.001,"TakerFee":0.001,"MinOrderListingCurrency":None,"PricePrecision":None},
    ...
    "TraderLevels":[{"Name":"prueba","MinVolumeAmount":0.001,"MinVolumeCurrency":"LTC2","MakerFeeRebate":0.01,"TakerFeeRebate":0.0}]}
    ...
    BALANCES = [{"Currency": "LTC2","Deposited": 118.19343,"Available": 118.19343,"Unconfirmed": 0.0},
    ...
    GET_ORDER_RESPONSE_BUY_CREATE = {'Type': 'buy', 'Amount': 1.0, 'LimitPrice': 86.24, 
    'ListingCurrency': 'LTC2', 'ReferenceCurrency': 'USD2', 'Status': 'pending', 'DateAdded': '2021-10-02T14:23:17.2'}

    GET_ORDER_RESPONSE_BUY_EXECUTED = {"Type":"buy","Amount":1.0,"LimitPrice":86.24,
    "ListingCurrency":"LTC2","ReferenceCurrency":"USD2","Status":"executed","DateAdded":"2021-10-10T12:32:29.167"}

    GET_ORDER_RESPONSE_BUY_CANCEL = {"Type":"buy","Amount":1.0,"LimitPrice":86.24,
    "ListingCurrency":"LTC2","ReferenceCurrency":"USD2","Status":"cancelednotexecuted","DateAdded":"2021-10-10T12:32:29.167"}

    GET_ORDER_RESPONSE_SELL_CREATE = {'Type': 'sell', 'Amount': 1.0, 'LimitPrice': 102.96, 
    'ListingCurrency': 'LTC2', 'ReferenceCurrency': 'USD2', 'Status': 'pending', 'DateAdded': '2021-10-02T14:23:17.2'}

    GET_ORDER_RESPONSE_SELL_EXECUTED = {"Type":"sell","Amount":1.0,"LimitPrice":86.24,
    "ListingCurrency":"LTC2","ReferenceCurrency":"USD2","Status":"executed","DateAdded":"2021-10-10T12:32:29.167"}

    GET_ORDER_RESPONSE_SELL_CANCEL = {"Type":"sell","Amount":1.0,"LimitPrice":86.24,
    "ListingCurrency":"LTC2","ReferenceCurrency":"USD2","Status":"cancelednotexecuted","DateAdded":"2021-10-10T12:32:29.167"}
    ...
    LIST_TRANSACTIONS_ = {"TotalElements":6,
                        "Result":[
