...
from kairos.core.event.events import BuyOrderCreatedEvent, MarketEvent, OrderExpiredEvent, SellOrderCreatedEvent
from kairos.model.order import Order
from kairos.model.trade_fill import TradeFill
from kairos.remote_iface.mqtt import MQTTGateway, MQTTMarketEventForwarder
...
class RemoteIfaceMQTTTests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.hbapp = KairosApplication(client_config_map=self.client_config_map)
        ...
        self.create_client_patcher = patch(
            'kairos.remote_iface.mqtt.MQTTGateway._create_client',
            _fake_create_client
        )
        ...
        self.no_network_patcher = patch(
            'kairos.remote_iface.mqtt.aiomqtt.Client',
        ...
        self.patch_loggers_patcher = patch(
            'kairos.remote_iface.mqtt.MQTTGateway.patch_loggers'
        )
    ...
    @patch("kairos.client.command.balance_command.BalanceCommand.balance")
    ...
    @patch("kairos.client.command.config_command.ConfigCommand.config")
    ...
    @patch("kairos.client.command.history_command.HistoryCommand.history")
    ...
    @patch("kairos.client.command.import_command.ImportCommand.import_config_file", new_callable=AsyncMock)
    ...
    @patch("kairos.client.command.status_command.StatusCommand.strategy_status", new_callable=AsyncMock)
    ...
    @patch("kairos.client.command.stop_command.StopCommand.stop")
    ...
    def test_mqtt_rpc_response_envelope_is_wire_compatible(self):
        ...
        with patch("kairos.client.command.balance_command.BalanceCommand.balance") as balance_mock:
            balance_mock.side_effect = self._create_exception_and_unlock_test_with_event
            self.start_mqtt()
            self.fake_mqtt_broker.publish_to_subscription(
    ...
    @patch("kairos.remote_iface.mqtt.mqtts_logger", None)
    ...
    def test_eevent_queue_factory(self):
        self.start_mqtt()
        from kairos.remote_iface.mqtt import EEventQueueFactory, ExternalEventFactory
    ...
    def test_eevent_listener_factory(self):
        self.start_mqtt()
        from kairos.remote_iface.mqtt import ExternalEventFactory
    ...
    def test_etopic_queue_factory(self):
        self.start_mqtt()
        from kairos.remote_iface.mqtt import ETopicQueueFactory, ExternalTopicFactory
    ...
    def test_etopic_listener_factory(self):
        self.start_mqtt()
        from kairos.remote_iface.mqtt import ExternalTopicFactory
    ...
    def test_external_events_add_remove(self):
        self.start_mqtt()
        from kairos.remote_iface.mqtt import MQTTGateway
    ...
    def test_mqtt_log_handler(self):
        ...
        from kairos.remote_iface.mqtt import MQTTLogHandler
        self.start_mqtt()
    ...
    def test_etopic_listener_class(self):
        from kairos.remote_iface.mqtt import ETopicListener
    ...
    def test_eevent_queue_factory_class(self):
        from kairos.remote_iface.mqtt import EEventQueueFactory
        self.start_mqtt()
    ...
    def test_eevent_listener_factory_class(self):
        from kairos.remote_iface.mqtt import EEventListenerFactory
        self.start_mqtt()
    ...
    def test_mqtt_external_events_class(self):
        from kairos.remote_iface.messages import ExternalEventMessage
        from kairos.remote_iface.mqtt import MQTTExternalEvents
    ...
    def test_etopic_publisher(self):
        self.start_mqtt()
        from kairos.remote_iface.mqtt import EMTopicPublisher, ETopicPublisher
        test_msg = {
            "a": "test",
            "b": 1,
            "c": False,
