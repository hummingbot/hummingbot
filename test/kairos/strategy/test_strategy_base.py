...
from kairos.connector.in_flight_order_base import InFlightOrderBase
...
from kairos.core.data_type.market_order import MarketOrder
...
class StrategyBaseUnitTests(unittest.TestCase):
    ...
    @unittest.mock.patch('kairos.client.kairos_application.KairosApplication.main_application')
    @unittest.mock.patch('kairos.client.kairos_application.KairosCLI')
    def test_notify_hb_app(self, cli_class_mock, main_application_function_mock):
        ...
        kairos_application = KairosApplication()
        main_application_function_mock.return_value = kairos_application
