...
from kairos.client.config.config_helpers import ClientConfigAdapter, ConfigValidationError
...
class AvellanedaMarketMakingConfigMapPydanticTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        with patch("kairos.core.utils.trading_pair_fetcher.TradingPairFetcher.fetch_all"):
    ...
    @patch("kairos.client.config.strategy_config_data_types.validate_market_trading_pair")
