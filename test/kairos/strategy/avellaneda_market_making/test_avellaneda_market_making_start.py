...
import kairos.strategy.avellaneda_market_making.start as strategy_start
...
class AvellanedaStartTest(IsolatedAsyncioWrapperTestCase):
    ...
    @unittest.mock.patch('kairos.strategy.avellaneda_market_making.start.KairosApplication')
