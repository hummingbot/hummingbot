...
import kairos.data_feed.candles_feed as candles_feed_pkg
from kairos.connector.exchange.binance import binance_constants
...
from kairos.data_feed.candles_feed.binance_spot_candles import (
    BinanceSpotCandles,
    ...
    def test_no_candle_feed_links_to_undefined_pool(self):
        ...
        for name in sorted(os.listdir(base)):
            ...
            if not os.path.isfile(constants_path):
                continue
            module = importlib.import_module(f"kairos.data_feed.candles_feed.{name}.constants")
