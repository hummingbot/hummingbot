...
class TestCandlesBase(IsolatedAsyncioWrapperTestCase, ABC):
    ...
    @patch("kairos.data_feed.candles_feed.candles_base.CandlesBase._time")
    ...
    @patch("kairos.data_feed.candles_feed.binance_perpetual_candles.BinancePerpetualCandles._sleep")
    ...
    @patch("kairos.data_feed.candles_feed.candles_base.CandlesBase._sleep")
    @patch("aiohttp.ClientSession.ws_connect", new_callable=AsyncMock)
    ...
    @patch("kairos.data_feed.candles_feed.candles_base.CandlesBase.fill_historical_candles", new_callable=AsyncMock)
    @patch("aiohttp.ClientSession.ws_connect", new_callable=AsyncMock)
    ...
    async def test_get_historical_candles_with_minimal_data(self):
        ...
        from kairos.data_feed.candles_feed.data_types import HistoricalCandlesConfig
