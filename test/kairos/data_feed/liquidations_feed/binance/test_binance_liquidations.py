...
from kairos.data_feed.liquidations_feed.binance import BinancePerpetualLiquidations, constants as CONSTANTS
from kairos.data_feed.liquidations_feed.liquidations_base import LiquidationSide
...
class TestBinanceLiquidations(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("kairos.data_feed.liquidations_feed.binance.BinancePerpetualLiquidations._sleep")
