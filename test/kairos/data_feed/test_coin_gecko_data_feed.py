...
from kairos.data_feed.coin_gecko_data_feed import CoinGeckoDataFeed, coin_gecko_constants as CONSTANTS
from kairos.data_feed.coin_gecko_data_feed.coin_gecko_constants import DEMO, PRO, PUBLIC
...
class CoinGeckoDataFeedTest(unittest.TestCase):
    ...
    @aioresponses()
    @patch(
        "kairos.data_feed.coin_gecko_data_feed.coin_gecko_data_feed.CoinGeckoDataFeed._async_sleep",
