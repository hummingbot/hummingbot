...
from kairos.core.data_type.order_book_query_result import OrderBookQueryResult
...
from kairos.strategy.strategy_v2_base import MarketDataProvider
...
class TestMarketDataProvider(IsolatedAsyncioWrapperTestCase):
    ...
    def test_initialize_candles_feed(self):
        with patch('kairos.data_feed.candles_feed.candles_factory.CandlesFactory.get_candle', return_value=MagicMock()):
    ...
    def test_get_rate(self):
        with patch("kairos.core.rate_oracle.rate_oracle.RateOracle.get_instance") as mock_get_instance:
    ...
    def test_get_candles_feed_existing_feed_stop(self):
        ...
        with patch('kairos.data_feed.candles_feed.candles_factory.CandlesFactory.get_candle') as mock_get_candle:
    ...
    @patch('kairos.client.settings.AllConnectorSettings.get_connector_config_keys')
    ...
    def test_get_candles_feed_passes_connector(self):
        ...
        self.provider.connectors = {"binance": connector}
        with patch(
            "kairos.data_feed.candles_feed.candles_factory.CandlesFactory.get_candle"
        ) as mock_get_candle:
