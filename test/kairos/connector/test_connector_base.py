...
from kairos.connector.connector_base import ConnectorBase, OrderFilledEvent
...
from kairos.core.data_type.in_flight_order import InFlightOrder
...
class ConnectorBaseUnitTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls._patcher = unittest.mock.patch("kairos.connector.connector_base.estimate_fee")
