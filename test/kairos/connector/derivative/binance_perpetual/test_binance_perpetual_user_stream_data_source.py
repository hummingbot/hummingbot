...
class BinancePerpetualUserStreamDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    @aioresponses()
    @patch("kairos.connector.derivative.binance_perpetual.binance_perpetual_user_stream_data_source.BinancePerpetualUserStreamDataSource._sleep")
    ...
    @patch(
        "kairos.connector.derivative.binance_perpetual.binance_perpetual_user_stream_data_source.BinancePerpetualUserStreamDataSource"
        "._ping_listen_key",
    ...
    @patch("kairos.connector.derivative.binance_perpetual.binance_perpetual_user_stream_data_source.safe_ensure_future")
