...
import kairos.connector.connector_metrics_collector
from kairos.connector.connector_metrics_collector import TradeVolumeMetricCollector
...
class TradeVolumeMetricCollectorTests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.original_client_version = kairos.connector.connector_metrics_collector.CLIENT_VERSION
        kairos.connector.connector_metrics_collector.CLIENT_VERSION = self.client_version
    ...
    def tearDown(self) -> None:
        kairos.connector.connector_metrics_collector.CLIENT_VERSION = self.original_client_version
        super().tearDown()
