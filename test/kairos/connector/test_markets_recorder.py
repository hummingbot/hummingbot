...
from kairos.client.config.client_config_map import ClientConfigMap, MarketDataCollectionConfigMap
...
from kairos.core.data_type.common import OrderType, PositionAction, PriceType, TradeType
from kairos.core.data_type.order_book import OrderBook
from kairos.core.data_type.trade_fee import AddedToCostTradeFee
...
from kairos.model.executors import Executors
from kairos.model.market_data import MarketData
from kairos.model.order import Order
from kairos.model.position import Position
...
from kairos.strategy.strategy_v2_base import StrategyV2Base
from kairos.strategy_v2.executors.position_executor.data_types import PositionExecutorConfig, TripleBarrierConfig
from kairos.strategy_v2.executors.position_executor.position_executor import PositionExecutor
...
class MarketsRecorderTests(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("kairos.model.sql_connection_manager.create_engine")
    ...
    def test_properties(self):
        ...
        self.assertIsInstance(recorder.logger(), KairosLogger)
    ...
    @patch("kairos.connector.markets_recorder.MarketsRecorder._sleep")
    ...
    def test_did_update_range_position_add_liquidity(self):
        ...
        from kairos.core.event.events import RangePositionLiquidityAddedEvent
        ...
        from kairos.model.range_position_update import RangePositionUpdate
        with self.manager.get_new_session() as session:
    ...
    def test_did_update_range_position_remove_liquidity(self):
        ...
        from kairos.core.event.events import RangePositionLiquidityRemovedEvent
