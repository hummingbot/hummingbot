...
from kairos.core.data_type.common import MarketDict, OrderType, PositionMode, TradeType
from kairos.data_feed.market_data_provider import MarketDataProvider
...
from kairos.strategy_v2.executors.position_executor.data_types import PositionExecutorConfig, TrailingStop
...
class TestMarketMakingControllerBase(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("kairos.strategy_v2.controllers.market_making_controller_base.MarketMakingControllerBase.get_executor_config", new_callable=MagicMock)
    ...
    def test_check_position_rebalance_below_threshold(self):
        ...
        with patch('kairos.strategy_v2.controllers.market_making_controller_base.MarketMakingControllerConfigBase.get_required_base_amount', return_value=Decimal("1.0")):
            result = controller.check_position_rebalance()
    ...
    def test_check_position_rebalance_buy_needed(self):
        ...
        with patch('kairos.strategy_v2.controllers.market_making_controller_base.MarketMakingControllerConfigBase.get_required_base_amount', return_value=Decimal("10.0")):
