...
from kairos.core.data_type.in_flight_order import InFlightOrder, OrderState, TradeUpdate
from kairos.core.data_type.order_candidate import OrderCandidate
from kairos.core.data_type.trade_fee import AddedToCostTradeFee, TokenAmount
from kairos.core.event.events import BuyOrderCompletedEvent, MarketOrderFailureEvent, OrderCancelledEvent
...
class TestPositionExecutor(IsolatedAsyncioWrapperTestCase):
    ...
    def test_properties(self):
        ...
        self.assertIsInstance(position_executor.logger(), KairosLogger)
    ...
    @patch.object(PositionExecutor, "get_trading_rules")
    @patch("kairos.strategy_v2.executors.position_executor.position_executor.PositionExecutor.get_price",
