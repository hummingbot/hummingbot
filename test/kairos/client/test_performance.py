...
from kairos.core.data_type.trade import Trade
from kairos.core.data_type.trade_fee import AddedToCostTradeFee, DeductedFromReturnsTradeFee, TokenAmount
from kairos.core.rate_oracle.rate_oracle import RateOracle
from kairos.model.order import Order  # noqa — Order needs to be defined for TradeFill
from kairos.model.order_status import OrderStatus  # noqa — Order needs to be defined for TradeFill
...
class PerformanceMetricsUnitTest(unittest.TestCase):
    ...
    @patch('kairos.client.performance.PerformanceMetrics._is_trade_fill')
