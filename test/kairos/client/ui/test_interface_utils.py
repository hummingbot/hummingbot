...
from kairos.client.ui.interface_utils import (
    format_bytes,
...
class InterfaceUtilsTest(unittest.TestCase):
    ...
    @patch("kairos.client.ui.interface_utils._sleep", new_callable=AsyncMock)
    ...
    @patch("kairos.client.ui.interface_utils._sleep", new_callable=AsyncMock)
    @patch("kairos.client.ui.interface_utils.PerformanceMetrics.create", new_callable=AsyncMock)
    @patch("kairos.client.kairos_application.KairosApplication")
