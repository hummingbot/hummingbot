...
class HummingbotCLITest(unittest.TestCase):
    ...
    @patch("kairos.client.ui.layout.Layout")
    @patch("kairos.client.ui.layout.FloatContainer")
    @patch("kairos.client.ui.layout.ConditionalContainer")
    @patch("kairos.client.ui.layout.Box")
    @patch("kairos.client.ui.layout.HSplit")
    @patch("kairos.client.ui.layout.VSplit")
    ...
    @patch("kairos.client.ui.kairos_cli.init_logging")
