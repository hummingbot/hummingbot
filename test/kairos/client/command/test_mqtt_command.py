...
class RemoteIfaceMQTTTests(IsolatedAsyncioWrapperTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.hbapp = KairosApplication(client_config_map=cls.client_config_map)
    ...
    @patch('kairos.remote_iface.mqtt.MQTTGateway.start')
    ...
    @patch('kairos.client.command.mqtt_command.MQTTCommand._mqtt_sleep_rate_autostart_retry', new_callable=PropertyMock)
    @patch('kairos.remote_iface.mqtt.MQTTGateway.health', new_callable=PropertyMock)
