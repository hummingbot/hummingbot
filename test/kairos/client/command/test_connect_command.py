...
from kairos.client.config.client_config_map import ClientConfigMap, DBSqliteMode
...
class ConnectCommandTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("kairos.client.config.security.Security.update_secure_config")
    @patch("kairos.client.config.security.Security.connector_config_file_exists")
    @patch("kairos.client.config.security.Security.api_keys")
    @patch("kairos.user.user_balances.UserBalances.add_exchange")
    ...
    @patch("kairos.user.user_balances.UserBalances.update_exchanges")
    @patch("kairos.client.config.security.Security.wait_til_decryption_done")
    ...
    @patch("kairos.client.kairos_application.KairosApplication.notify")
    @patch("kairos.client.kairos_application.KairosApplication.connection_df")
