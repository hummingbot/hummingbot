...
from kairos.client.config.config_helpers import read_system_configs_from_yml
...
class BalanceCommandTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("kairos.user.user_balances.UserBalances.all_balances_all_exchanges")
    ...
    @patch("kairos.user.user_balances.UserBalances.all_available_balances_all_exchanges")
    @patch("kairos.user.user_balances.UserBalances.all_balances_all_exchanges")
    ...
    @patch("kairos.core.rate_oracle.rate_oracle.RateOracle.get_rate")
    @patch("kairos.user.user_balances.UserBalances.all_available_balances_all_exchanges")
    @patch("kairos.user.user_balances.UserBalances.all_balances_all_exchanges")
