...
from kairos.cli.commands.stop import stop
...
class StopCommandTest(unittest.TestCase):
    ...
    def test_graceful_stop(self):
        ...
        with patch.object(bot, "exists", return_value=True), \
                ...
                patch.object(bot, "clear_pid") as clear_pid, \
                patch("kairos.cli.commands.stop.os") as os_mock, \
                patch("kairos.cli.commands.stop.time") as time_mock, \
                patch("kairos.cli.commands.stop.emit") as emit_mock:
