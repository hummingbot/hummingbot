...
import kairos.connector.exchange.binance.binance_web_utils as web_utils
import kairos.core.utils.market_price as market_price
...
class MarketPriceUnitTests(unittest.TestCase):
    ...
    @aioresponses()
    @patch("kairos.client.settings.ConnectorSetting.non_trading_connector_instance_with_default_configuration")
