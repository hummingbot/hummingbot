...
from kairos.core.api_throttler.async_throttler import AsyncRequestContext, AsyncThrottler
...
class AsyncThrottlerUnitTests(unittest.TestCase):
    ...
    @patch("kairos.core.api_throttler.async_throttler.AsyncRequestContext._time")
