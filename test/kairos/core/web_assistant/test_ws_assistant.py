...
from kairos.core.web_assistant.connections.connections_factory import ConnectionsFactory
from kairos.core.web_assistant.connections.data_types import RESTRequest, WSJSONRequest, WSRequest, WSResponse
from kairos.core.web_assistant.connections.ws_connection import WSConnection
from kairos.core.web_assistant.ws_assistant import WSAssistant
from kairos.core.web_assistant.ws_post_processors import WSPostProcessorBase
from kairos.core.web_assistant.ws_pre_processors import WSPreProcessorBase
...
class WSAssistantTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("kairos.core.web_assistant.connections.ws_connection.WSConnection.connect")
    ...
    @patch("kairos.core.web_assistant.connections.ws_connection.WSConnection.disconnect")
    async def test_disconnect(self, disconnect_mock):
        await (self.ws_assistant.disconnect())

        disconnect_mock.assert_called()

    @patch("kairos.core.web_assistant.connections.ws_connection.WSConnection.send")
    ...
    @patch("kairos.core.web_assistant.connections.ws_connection.WSConnection.receive")
    ...
    @patch(
        "kairos.core.web_assistant.connections.ws_connection.WSConnection.connected",
