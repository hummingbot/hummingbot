...
class TrackingNonceTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_concurrent_nonce_in_low_res(self):
        async def task():
    ...
    async def test_get_concurrent_nonce_in_high_res(self):
        async def task():
