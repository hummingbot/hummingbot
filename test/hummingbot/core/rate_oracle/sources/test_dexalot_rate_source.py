...
class DexalotRateSourceTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("aiohttp.ClientSession.ws_connect", new_callable=AsyncMock)
    @aioresponses()
    async def test_get_prices_skips_records_with_invalid_low_high(self, mock_api, ws_connect_mock):
        """Records with non-numeric or None low/high values should be skipped, not crash."""
        rate_source = DexalotRateSource()
        symbols_url = web_utils.public_rest_url(path_url=CONSTANTS.EXCHANGE_INFO_PATH_URL)
        symbols_response = [
            {'env': 'production-multi-subnet', 'pair': 'ALOT/USDC', 'base': 'ALOT', 'quote': 'USDC',
        ...
        # Mix of valid records and records with invalid low/high (None, empty string, non-numeric)
        result_subscribe = {'data': [
            {'pair': 'ALOT/USDC', 'date': '2024-10-04T08:54:32.021Z', 'low': '9', 'high': '11',
             'open': '0.56', 'close': '0.55', 'volume': '100', 'quote_volume': '100', 'change': '0'},
            {'pair': 'BAD1/USDC', 'date': '2024-10-04T08:54:32.021Z', 'low': None, 'high': '11',
             'open': '0.56', 'close': '0.55', 'volume': '100', 'quote_volume': '100', 'change': '0'},
            {'pair': 'BAD2/USDC', 'date': '2024-10-04T08:54:32.021Z', 'low': '', 'high': '',
             'open': '0.56', 'close': '0.55', 'volume': '100', 'quote_volume': '100', 'change': '0'},
            {'pair': 'BAD3/USDC', 'date': '2024-10-04T08:54:32.021Z', 'low': 'N/A', 'high': 'N/A',
             'open': '0.56', 'close': '0.55', 'volume': '100', 'quote_volume': '100', 'change': '0'},
        ], 'type': 'marketSnapShot'}
        ...
        # Should not crash — invalid records are silently skipped
