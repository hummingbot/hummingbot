...
from hummingbot.strategy.pure_market_making_app import PureMarketMakingStrategyAugmentedPurePython

logging.basicConfig(level=logging.ERROR)


class PMMRefreshToleranceUnitAPPTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.one_level_strategy: PureMarketMakingStrategyAugmentedPurePython = PureMarketMakingStrategyAugmentedPurePython()
        ...
        self.multi_levels_strategy: PureMarketMakingStrategyAugmentedPurePython = PureMarketMakingStrategyAugmentedPurePython()
        ...
        self.hanging_order_multiple_strategy = PureMarketMakingStrategyAugmentedPurePython()
