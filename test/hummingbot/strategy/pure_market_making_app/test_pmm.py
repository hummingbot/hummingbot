...
from hummingbot.strategy.pure_market_making_app.pure_market_making_app import (
    PureMarketMakingStrategyAugmentedPurePython,
)
...
class PMMUnitTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.one_level_strategy = PureMarketMakingStrategyAugmentedPurePython()
        ...
        self.multi_levels_strategy = PureMarketMakingStrategyAugmentedPurePython()
        ...
        self.order_override_strategy = PureMarketMakingStrategyAugmentedPurePython()
        ...
        self.custom_price_source_strategy = PureMarketMakingStrategyAugmentedPurePython()
        ...
        self.split_order_level_strategy = PureMarketMakingStrategyAugmentedPurePython()
    ...
    def test_basic_one_level_price_type_own_last_trade(self):
        strategy = PureMarketMakingStrategyAugmentedPurePython()
...
class PureMarketMakingMinimumSpreadUnitTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy: PureMarketMakingStrategyAugmentedPurePython = PureMarketMakingStrategyAugmentedPurePython()
