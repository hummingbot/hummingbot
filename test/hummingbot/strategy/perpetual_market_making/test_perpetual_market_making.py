...
from hummingbot.core.event.events import PositionMode, OrderType, PositionSide, MarketEvent, OrderFilledEvent, \
    TradeType, TradeFee, BuyOrderCompletedEvent, SellOrderCompletedEvent, PriceType
...
class PerpetualMarketMakingTests(TestCase):
    ...
    def setUp(self):
        super().setUp()
        self.log_records = []
        self.market: MockPerpConnector = MockPerpConnector(fee_percent=Decimal("25"))
