...
class PureMarketMakingStartTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        c_map.get("bid_order_level_spread").value = Decimal("0.2")
        c_map.get("ask_order_level_spread").value = Decimal("0.2")
    ...
    def test_strategy_creation(self):
        ...
        self.assertEqual(self.strategy.bid_order_level_spread, Decimal("0.002"))
        self.assertEqual(self.strategy.ask_order_level_spread, Decimal("0.002"))
