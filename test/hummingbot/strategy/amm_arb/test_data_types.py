...
class ArbProposalTests(TestCase):
    ...
    def test_profit_is_zero_when_no_available_sell_to_buy_quote_rate(self):
        ...
        buy_side = ArbProposalSide(buy_market_info, True, Decimal(30000), Decimal(30000), Decimal(10), [])
        sell_side = ArbProposalSide(sell_market_info, False, Decimal(32000), Decimal(32000), Decimal(10), [])
    ...
    def test_profit_without_fees_for_different_quotes_trading_pairs(self):
        ...
        buy_side = ArbProposalSide(buy_market_info, True, Decimal(30000), Decimal(30000), Decimal(10), [])
        sell_side = ArbProposalSide(sell_market_info, False, Decimal(10), Decimal(10), Decimal(10), [])
        ...
        profit = proposal.profit_pct(account_for_fee=False, rate_source=rate_source)
    ...
    def test_profit_without_fees_for_different_base_trading_pairs_and_different_amount_on_sides(self):
        ...
        buy_side = ArbProposalSide(buy_market_info, True, Decimal(30000), Decimal(30000), Decimal(10), [])
        sell_side = ArbProposalSide(sell_market_info, False, Decimal(1.1), Decimal(1.1), Decimal(27000), [])
    ...
    def test_profit_with_network_fees(self, _):
        ...
        expected_sell_result: Decimal = (
            sell_side.amount * sell_side.quote_price - sell_side.extra_flat_fees[0].amount * sell_side.quote_price
        )
