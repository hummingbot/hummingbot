...
class TwapTradeStrategyTest(TestCase):
    ...
    def test_creation_without_market_info_fails(self):
        with self.assertRaises(ValueError) as ex_context:
            TwapTradeStrategy(market_infos=[], is_buy=True, target_asset_amount=1, order_step_size=1, order_price=1)
    ...
    def test_start(self):
        ...
        strategy = TwapTradeStrategy(
            market_infos=[marketTuple], is_buy=True, target_asset_amount=1, order_step_size=1, order_price=1
        )
