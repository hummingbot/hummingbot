...
class InterfaceUtilsTest(unittest.TestCase):
    ...
    def test_start_timer(self, mock_sleep):
        ...
        self.assertEqual('Uptime:   0 day(s), 0:00:02', mock_timer.log.call_args_list[0].args[0])
        self.assertEqual('Uptime:   0 day(s), 0:00:03', mock_timer.log.call_args_list[1].args[0])
