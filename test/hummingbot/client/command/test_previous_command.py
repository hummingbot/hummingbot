...
class PreviousCommandUnitTest(unittest.TestCase):
    ...
    def test_no_previous_strategy_found(self):
        ...
        self.assertTrue(self.cli_mock_assistant.check_log_called_with("No previous strategy found."))
    ...
    def test_strategy_found_and_user_declines(self, import_command: MagicMock):
        ...
        self.async_run_with_timeout(self.app.prompt_for_previous_strategy(strategy_name))
