...
from hummingbot.connector.gateway_EVM_AMM_LP import GatewayEVMAMMLP, GatewayInFlightLPOrder
...
class GatewayEVMAMMLPConnectorUnitTest(unittest.TestCase):
    ...
    async def test_get_allowances(self):
        ...
        self.assertGreater(allowances.get("COIN1"), big_num)
        self.assertGreater(allowances.get("COIN3"), big_num)
