...
class BinancetestnetAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.connector = BinancetestnetExchange(
            ...
            domain=self.domain)
        self.data_source = BinancetestnetAPIOrderBookDataSource(trading_pairs=[self.trading_pair],
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.binancetestnet.binancetestnet_api_order_book_data_source"
           ".BinancetestnetAPIOrderBookDataSource._sleep")
