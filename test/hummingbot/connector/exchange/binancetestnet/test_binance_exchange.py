...
class BinancetestnetExchangeTests(AbstractExchangeConnectorTests.ExchangeConnectorTests):
    ...
    def create_exchange_instance(self):
        ...
        return BinancetestnetExchange(
            ...
            binancetestnet_api_key="testAPIKey",
            binancetestnet_api_secret="testSecret",
    ...
    def validate_order_creation_request(self, order: InFlightOrder, request_call: RequestCall):
        ...
        self.assertEqual(BinancetestnetExchange.binancetestnet_order_type(OrderType.LIMIT), request_data["type"])
    ...
    def test_update_order_fills_request_parameters(self, mock_api):
        ...
        self.exchange._last_poll_timestamp = (self.exchange.current_timestamp -
                                              self.exchange.UPDATE_ORDER_STATUS_MIN_INTERVAL - 1)
        self.exchange._last_trades_poll_binancetestnet_timestamp = 10
        self.async_run_with_timeout(self.exchange._update_order_fills_from_trades())
    ...
    def test_time_synchronizer_related_request_error_detection(self):
        exception = IOError("Error executing request POST https://api.binancetestnet.com/api/v3/order. HTTP status is 400. "
