...
from hummingbot.connector.exchange.binancetestnet import binancetestnet_constants as CONSTANTS, binancetestnet_web_utils as web_utils
...
from hummingbot.connector.exchange.binancetestnet.binancetestnet_exchange import BinancetestnetExchange
from hummingbot.connector.test_support.network_mocking_assistant import NetworkMockingAssistant
from hummingbot.connector.time_synchronizer import TimeSynchronizer
from hummingbot.core.api_throttler.async_throttler import AsyncThrottler


class BinancetestnetUserStreamDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.auth = BinancetestnetAuth(api_key="TEST_API_KEY", secret_key="TEST_SECRET", time_provider=self.mock_time_provider)
        self.time_synchronizer = TimeSynchronizer()
        self.time_synchronizer.add_time_offset_ms_sample(0)

        client_config_map = ClientConfigAdapter(ClientConfigMap())
        self.connector = BinancetestnetExchange(
        ...
        self.data_source = BinancetestnetAPIUserStreamDataSource(
            auth=self.auth,
    ...
    @patch("hummingbot.connector.exchange.binancetestnet.binancetestnet_api_user_stream_data_source.BinancetestnetAPIUserStreamDataSource"
           "._ping_listen_key",
