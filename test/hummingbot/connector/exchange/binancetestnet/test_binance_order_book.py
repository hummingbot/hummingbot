...
class BinancetestnetOrderBookTests(TestCase):

    def test_snapshot_message_from_exchange(self):
        snapshot_message = BinancetestnetOrderBook.snapshot_message_from_exchange(
            msg={
                "lastUpdateId": 1,
                "bids": [
    ...
    def test_diff_message_from_exchange(self):
        diff_msg = BinancetestnetOrderBook.diff_message_from_exchange(
            msg={
                "e": "depthUpdate",
                "E": 123456789,
                "s": "COINALPHAHBOT",
