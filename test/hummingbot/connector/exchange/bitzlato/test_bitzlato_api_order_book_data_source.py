...
class BitzlatoAPIOrderBookDataSourceTests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data_source = BitzlatoAPIOrderBookDataSource(
    ...
    def test_get_last_traded_prices(self, mock_api):
        ...
        results = self.async_run_with_timeout(BitzlatoAPIOrderBookDataSource.get_last_traded_prices(
            trading_pairs=[self.trading_pair],
            throttler=self.throttler))
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.bitzlato.bitzlato_http_utils.retry_sleep_time")
    ...
    def test_fetch_trading_pairs(self, mock_api):
        ...
        results = self.async_run_with_timeout(BitzlatoAPIOrderBookDataSource.fetch_trading_pairs(
            throttler=self.throttler), timeout=60)
    ...
    @patch("hummingbot.connector.exchange.bitzlato.bitzlato_api_order_book_data_source.BitzlatoAPIOrderBookDataSource._time")
    @aioresponses()
    def test_get_new_order_book(self, time_mock, mock_api):
        ...
        order_book: BitzlatoOrderBook = self.async_run_with_timeout(
    ...
    @aioresponses()
    @patch(
        "hummingbot.connector.exchange.bitzlato.bitzlato_api_order_book_data_source.BitzlatoAPIOrderBookDataSource._sleep",
    ...
    def test_listen_for_trades_unrecognised(self, ws_connect_mock):
        ...
        self.assertTrue(self._is_logged("INFO",
                                        "Unrecognized message received from Bitzlato websocket: {'hbotusdttrades': {}}"))
    ...
    def test_listen_for_order_book_diff_unrecognised(self, ws_connect_mock, time_mock):
        ...
        self.assertTrue(self._is_logged("INFO",
                                        "Unrecognized message received from Bitzlato websocket: {'snapcracklepop': {}}"))
