...
from hummingbot.connector.exchange.bitzlato.bitzlato_api_user_stream_data_source import BitzlatoAPIUserStreamDataSource
...
class TestBitzlatoAPIUserStreamDataSource(unittest.TestCase):
    @classmethod
    ...
    def setUp(self) -> None:
        ...
        bitzlato_auth = BitzlatoAuth(api_key="someKey", secret_key="someSecret")
        self.data_source = BitzlatoAPIUserStreamDataSource(AsyncThrottler(Constants.RATE_LIMITS), bitzlato_auth=bitzlato_auth, trading_pairs=[self.trading_pair])
