...
from hummingbot.connector.exchange.bitzlato.bitzlato_exchange import BitzlatoExchange
...
class BitzlatoExchangeTests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.exchange = BitzlatoExchange(
            client_config_map=self.client_config_map,
            bitzlato_api_key=self.api_key,
            bitzlato_secret_key=self.api_secret_key,
    ...
    def get_in_flight_order(self,
                            ...
                            exchange_order_id: str = "someExchId",
                            amount: str = "1",
                            price: str = "5.1") -> BitzlatoInFlightOrder:
        order = BitzlatoInFlightOrder(
            client_order_id,
            exchange_order_id,
            self.trading_pair,
            OrderType.LIMIT,
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.bitzlato.bitzlato_exchange.BitzlatoExchange.current_timestamp")
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.bitzlato.bitzlato_exchange.BitzlatoExchange._sleep_time")
    ...
    @patch("hummingbot.connector.exchange.bitzlato.bitzlato_exchange.BitzlatoExchange._update_balances")
