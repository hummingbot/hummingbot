...
from hummingbot.connector.exchange.alpha_point.alpha_point_web_utils import build_api_factory
from hummingbot.connector.test_support.network_mocking_assistant import NetworkMockingAssistant


class AlphaPointAuthTest(unittest.TestCase):
    @classmethod
    ...
    def setUp(self, time_mock: MagicMock) -> None:
        ...
        self.auth = AlphaPointAuth(self.api_key, self.secret, self.user_id)
