...
class AscendExUserStreamTrackerTests(TestCase):
    ...
    def test_listening_process_authenticates_and_subscribes_to_events(self, api_mock, ws_connect_mock):
        ...
        ret["output_queue authentication"] = self.ev_loop.run_until_complete(output_queue.get())
        ...
        ret["output_queue first message"] = self.ev_loop.run_until_complete(output_queue.get())
