...
class DataFormatterTests(TestCase):
    ...
    def test_format_balance_response(self):
        response = {
            "result": {
                "Ethereum": [
                    {"asset": "ETH", "balance": "0x2386f26fc0bda2"},
                    {"asset": "FLIP", "balance": "0xde0b6b3a763ec60"},
                    {"asset": "USDC", "balance": "0x8bb50bca00"},
                ],
            }
        }
    ...
    def test_format_orderbook_response(self):
        response = {
            "result": {
                "asks": [
                    {"amount": "0x54b2cec31723f8b04", "sqrt_price": "0x2091b342e50d7f26cdc582"},
                    {"amount": "0x5b475d13fc0374e", "sqrt_price": "0x1e38a26ccc8cad8ff5ed7d0e"},
                    {"amount": "0x625ecb4a48690", "sqrt_price": "0x1c0ae64c925b19f39a41ff17bd"},
                    {"amount": "0x6a03445844f", "sqrt_price": "0x1a055f3578ef64659516605ff66d"},
                ],
                "bids": [
                    {"amount": "0x9a488cdb615edf25fd", "sqrt_price": "0x62bac2a2b8f0b98b9ceb"},
                    {"amount": "0x1217d98319cd00bc28de", "sqrt_price": "0x349e212a7a008282ff9"},
                    {"amount": "0x21f2ffe1f3cc8bebab567", "sqrt_price": "0x1c0ae0758c0acee837"},
                    {"amount": "0x3fb3690cb0511666161b4d", "sqrt_price": "0xef1f790088e3f323"},
                ],
            },
        }
