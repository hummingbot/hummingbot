...
class TegroAuthTests(TestCase):
    ...
    def test_rest_authenticate_adds_signature_to_post_request(self, mock_encode_defunct, mock_sign_message):
        # Mocking dependencies
        mock_encode_defunct.return_value = "encoded_data"
        mock_sign_message.return_value = mock.Mock(
            signature=HexBytes("0xc5bb16ccc59ae9a3ad1cb8343d4e3351f057c994a97656e1aff8c134e56f7530")  # noqa: mock
        )
        ...
        # Assertions
        expected_signature = "0xc5bb16ccc59ae9a3ad1cb8343d4e3351f057c994a97656e1aff8c134e56f7530"  # noqa: mock
        ...
        mock_sign_message.assert_called_once_with("encoded_data", private_key=expected_private_key)
