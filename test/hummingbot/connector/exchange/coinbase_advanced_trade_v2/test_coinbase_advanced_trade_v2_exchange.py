...
class CoinbaseAdvancedTradeV2ExchangeTests(AbstractExchangeConnectorTests.ExchangeConnectorTests):
    ...
    def create_exchange_instance(self):
        ...
        return CoinbaseAdvancedTradeV2Exchange(
            client_config_map=client_config_map,
            coinbase_advanced_trade_v2_api_key="testAPIKey",
            coinbase_advanced_trade_v2_api_secret="testSecret",
    ...
    def validate_order_creation_request(self, order: InFlightOrder, request_call: RequestCall):
        ...
        self.assertEqual(CoinbaseAdvancedTradeV2Exchange.coinbase_advanced_trade_v2_order_type(OrderType.LIMIT), request_data["type"])
    ...
    def test_update_order_fills_request_parameters(self, mock_api):
        ...
        self.exchange._last_poll_timestamp = (self.exchange.current_timestamp -
                                              self.exchange.UPDATE_ORDER_STATUS_MIN_INTERVAL - 1)
        self.exchange._last_trades_poll_coinbase_advanced_trade_v2_timestamp = 10
        self.async_run_with_timeout(self.exchange._update_order_fills_from_trades())
    ...
    def test_time_synchronizer_related_request_error_detection(self):
        exception = IOError("Error executing request POST https://api.coinbase_advanced_trade_v2.com/api/v3/order. HTTP status is 400. "
