...
class CoinbaseAdvancedTradeV2AuthTests(TestCase):
    ...
    def test_rest_authenticate(self):
        ...
        auth = CoinbaseAdvancedTradeV2Auth(api_key=self._api_key, secret_key=self._secret, time_provider=mock_time_provider)
