...
class CoinbaseAdvancedTradeV2APIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    @aioresponses()
    @patch(
        "hummingbot.connector.exchange.coinbase_advanced_trade_v2.coinbase_advanced_trade_v2_api_order_book_data_source"
        ".CoinbaseAdvancedTradeV2APIOrderBookDataSource._sleep")
