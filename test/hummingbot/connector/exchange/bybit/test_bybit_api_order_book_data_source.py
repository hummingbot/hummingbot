...
class TestBybitAPIOrderBookDataSource(IsolatedAsyncioWrapperTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.connector = BybitExchange(bybit_api_key="", bybit_api_secret="", trading_pairs=[self.trading_pair])
    ...
    async def test_listen_for_subscriptions_subscribes_to_trades_and_depth(self, ws_connect_mock):
        ...
        result_subscribe_trades = {
            ...
            "params": {"binary": "false", "symbolName": self.ex_trading_pair},
            "code": "0",
            "msg": "Success",
        }
        ...
        expected_trade_subscription = {"op": "subscribe", "args": ["publicTrade.COINALPHAHBOT"]}
        self.assertEqual(expected_trade_subscription, sent_subscription_messages[0])
        expected_diff_subscription = {"op": "subscribe", "args": ["orderbook.50.COINALPHAHBOT"]}
