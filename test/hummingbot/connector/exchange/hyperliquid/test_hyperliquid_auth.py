...
class HyperliquidAuthTests(TestCase):
    def setUp(self) -> None:
        ...
        self.trading_required = False # noqa: mock
        self.auth = HyperliquidAuth(api_key=self.api_key, api_secret=self.secret_key, use_vault=self.use_vault, trading_required=self.trading_required)
