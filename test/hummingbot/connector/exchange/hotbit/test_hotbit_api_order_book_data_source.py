...
class HotbitAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data_source = HotbitAPIOrderBookDataSource(trading_pairs=[self.trading_pair], connector=self.connector, api_factory=self.connector._web_assistants_factory)
    ...
    def _order_diff_event(self):
        resp = {
            "method": "depth.update",
            "params": [True, {"asks": [["8000", "20"]], "bids": [["800", "4"]]}, self.ex_trading_pair],
            "id": None
        }
        return resp
    ...
    def test_get_new_order_book_successful(self, mock_api):
        ...
        self.assertEqual(0.0730197, bids[0].price)
        self.assertEqual(0.275, bids[0].amount)
        self.assertEqual(expected_update_id, bids[0].update_id)
        self.assertEqual(4, len(asks))
        self.assertEqual(0.0733858, asks[0].price)
        self.assertEqual(0.319, asks[0].amount)
    ...
    def test_listen_for_subscriptions_subscribes_to_trades_and_order_diffs(self, ws_connect_mock):
        ...
        expected_trade_subscription = {
            ...
            "params": [f"{self.ex_trading_pair.upper()}"],
            "id": 1}
        self.assertEqual(expected_trade_subscription, sent_subscription_messages[0])
        expected_diff_subscription = {
            "method": "depths.subscribe",
            "params": [[f"{self.ex_trading_pair.upper()}", 10, '0.0001']],
            "id": 2}
    ...
    def test_listen_for_trades_successful(self):
        ...
        self.assertEqual(26, msg.trade_id)
    ...
    def test_listen_for_order_book_diffs_successful(self):
        ...
        self.assertEqual(diff_event["id"], msg.update_id)
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.hotbit.hotbit_api_order_book_data_source"
           ".HotbitAPIOrderBookDataSource._sleep")
    ...
    def test_listen_for_order_book_snapshots_successful(self, mock_api, ):
        ...
        self.assertEqual(1527559250, msg.update_id)
