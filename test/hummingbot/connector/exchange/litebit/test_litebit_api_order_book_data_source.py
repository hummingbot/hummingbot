...
class LitebitAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data_source = LitebitAPIOrderBookDataSource(trading_pairs=[self.trading_pair],
    ...
    def _trade_update_event(self):
        resp = {"event": "trade", "data": {"uuid": "9beba3ae-4755-4f06-82be-60b2a3452926", "amount": "0.41322185",
                "price": "38218.40000000", "side": "buy", "timestamp": 1622123573863, "market": "BTC-EUR"}}
        return resp

    def _order_diff_event(self):
        resp = {"event": "book", "data": {"market": "BTC-EUR", "sequence": 1231232, "update_type": "delta",
                "timestamp": 1622123573863, "bids": [["0.0024", "10"]], "asks": [["0.0026", "100"]]}}
        return resp

    def _snapshot_event(self):
        resp = {"event": "book", "data": self._snapshot_response()}
        return resp

    def _snapshot_response(self):
        resp = {"market": "BTC-EUR", "sequence": 1231232, "update_type": "snapshot", "timestamp": 1622123573863,
                "bids": [["4.00000000", "431.00000000"]], "asks": [["4.00000200", "12.00000000"]]}
        return resp

    @aioresponses()
    def test_get_new_order_book_successful(self, mock_api):
        url = web_utils.public_rest_url(path_url=CONSTANTS.GET_BOOK_PATH, domain=self.domain)
        ...
        expected_update_id = resp["sequence"]
    ...
    def test_listen_for_subscriptions_subscribes_to_trades_and_order_diffs(self, ws_connect_mock):
        ...
        result_subscribe = {"rid": 1, "event": "subscribe"}
        ...
        expected_trade_subscription = {
            "rid": 1,
            "event": "subscribe",
            "data": [f"book:{self.ex_trading_pair}", f"trades:{self.ex_trading_pair}"],
        }
    ...
    def test_listen_for_trades_successful(self):
        ...
        self.assertEqual("9beba3ae-4755-4f06-82be-60b2a3452926", msg.trade_id)
    ...
    def test_listen_for_order_book_diffs_successful(self):
        ...
        self.assertEqual(diff_event["data"]["sequence"], msg.update_id)
    ...
    @patch("hummingbot.connector.exchange.litebit.litebit_api_order_book_data_source"
           ".LitebitAPIOrderBookDataSource._sleep")
    ...
    def test_listen_for_order_book_snapshots_successful(self, ):
        ...
        self.assertEqual(snapshot_event["data"]["sequence"], msg.update_id)
