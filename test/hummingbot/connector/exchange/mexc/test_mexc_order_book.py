...
class MexcOrderBookTests(TestCase):
    ...
    def test_diff_message_from_exchange(self):
        diff_msg = MexcOrderBook.diff_message_from_exchange(
            msg={
                ...
                "publicAggreDepths": {
                    "bids": [{"price": "114838.84", "quantity": "0.000101"}],
                    "asks": [{"price": "115198.74", "quantity": "0.068865"}],
    ...
    def test_trade_message_from_exchange(self):
        trade_update = {"price": "115091.25", "quantity": "0.000059", "tradeType": 1, "time": "1755973886258"}

        trade_message = MexcOrderBook.trade_message_from_exchange(
            msg=trade_update, metadata={"trading_pair": "BTC-USDC"}, timestamp=float("1755973886258")
        )
