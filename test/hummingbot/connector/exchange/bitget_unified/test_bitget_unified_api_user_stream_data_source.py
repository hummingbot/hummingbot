...
class BitgetUnifiedAPIUserStreamDataSourceTests(IsolatedAsyncioWrapperTestCase):
    """
    Unit tests for BitgetUnifiedAPIUserStreamDataSource class
    """
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.auth = BitgetUnifiedAuth(
            api_key="test_api_key",
            secret_key="test_secret_key",
            passphrase="test_passphrase",
            time_provider=self.time_synchronizer
        )
        self.connector = BitgetUnifiedExchange(
        ...
        self.data_source = BitgetUnifiedAPIUserStreamDataSource(
            auth=self.auth,
            trading_pairs=[self.trading_pair],
