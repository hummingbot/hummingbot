...
class BitgetUnifiedAPIOrderBookDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    """
    Unit tests for BitgetUnifiedAPIOrderBookDataSource class
    """
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.data_source = BitgetUnifiedAPIOrderBookDataSource(
            trading_pairs=[self.trading_pair],
