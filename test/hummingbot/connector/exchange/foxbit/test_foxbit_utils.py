...
class FoxbitUtilTestCases(unittest.TestCase):
    ...
    def test_ws_data_to_dict(self):
        _expectedValue = [
            {"Key": "field0", "Value": "Google"},
            {"Key": "field2", "Value": None},
            {"Key": "field3", "Value": "São Paulo"},
            {"Key": "field4", "Value": False},
            {"Key": "field5", "Value": "SAO PAULO"},
            {"Key": "field6", "Value": "00000001"},
            {"Key": "field7", "Value": True},
        ]
