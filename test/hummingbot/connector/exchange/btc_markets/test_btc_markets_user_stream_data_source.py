...
class BtcMarketsAPIUserStreamDataSourceUnitTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.auth = BtcMarketsAuth(api_key=cls.api_key, secret_key=cls.secret_key)
    ...
    def setUp(self) -> None:
        ...
        self.data_source = BtcMarketsAPIUserStreamDataSource(btc_markets_auth=self.auth)
    ...
    def test_get_shared_client_shared_client_provided(self):
        ...
        data_source = BtcMarketsAPIUserStreamDataSource(btc_markets_auth=self.auth, shared_client=aiohttp_client)
