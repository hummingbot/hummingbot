...
class BtcMarketsWebSocketUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.websocket = BtcMarketsWebsocket(auth=self.auth)
    ...
    def test_connect_raises_exception(self, _, ws_connect_mock):
        ...
        self.websocket = BtcMarketsWebsocket()
    ...
    def test_connect_authenticate_is_called(self, _, ws_connect_mock):
        ...
        self.assertEqual(BtcMarketsWebsocket.AUTH_REQUEST, sent_payloads[0]["method"])
