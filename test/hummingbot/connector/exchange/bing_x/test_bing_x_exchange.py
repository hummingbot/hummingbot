...
class TestBingXExchange(unittest.TestCase):
    ...
    # @aioresponses()
    # @patch("hummingbot.connector.exchange.bing_x.bing_x_exchange.BingXExchange.get_price")
    ...
    #     self.assertEqual("AURA-USDT", request_data["symbol"])
    ...
    #     response = {"code": 0, "msg": "", "data": {"serverTime": 1698915507859}}

    #     mock_api.get(regex_url, body=json.dumps(response))

    #     self.async_run_with_timeout(self.exchange._update_time_synchronizer())
    #     self.assertEqual(response["data"]['serverTime'] * 1e-3, self.exchange._time_synchronizer.time())
