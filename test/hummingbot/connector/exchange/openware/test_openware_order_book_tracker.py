...
class OpenwareOrderBookTrackerUnitTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.tracker: OpenwareOrderBookTracker = OpenwareOrderBookTracker(throttler, [self.trading_pair])
        self.tracking_task = None

        # Simulate start()
        self.tracker._order_books[self.trading_pair] = OpenwareOrderBook()
    ...
    def simulate_queue_order_book_messages(self, message: OpenwareOrderBookMessage):
    ...
    def test_track_single_book_apply_snapshot(self):
        ...
        snapshot_msg = OpenwareOrderBook.snapshot_message_from_exchange(
            msg=snapshot_data,
