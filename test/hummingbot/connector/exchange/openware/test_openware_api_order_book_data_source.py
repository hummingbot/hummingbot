...
from hummingbot.connector.exchange.openware.openware_utils import convert_to_exchange_trading_pair
from hummingbot.connector.test_support.network_mocking_assistant import NetworkMockingAssistant
from hummingbot.core.api_throttler.async_throttler import AsyncThrottler
from hummingbot.core.data_type.order_book_message import OrderBookMessage, OrderBookMessageType


class OpenwareAPIOrderBookDataSourceTests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data_source = OpenwareAPIOrderBookDataSource(
    ...
    def test_get_last_traded_prices(self, mock_api):
        ...
        results = self.async_run_with_timeout(OpenwareAPIOrderBookDataSource.get_last_traded_prices(
            trading_pairs=[self.trading_pair],
            throttler=self.throttler))
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.openware.openware_http_utils.retry_sleep_time")
    ...
    def test_fetch_trading_pairs(self, mock_api):
        ...
        results = self.async_run_with_timeout(OpenwareAPIOrderBookDataSource.fetch_trading_pairs(
            throttler=self.throttler))
    ...
    @patch("hummingbot.connector.exchange.openware.openware_api_order_book_data_source.OpenwareAPIOrderBookDataSource._time")
    @aioresponses()
    def test_get_new_order_book(self, time_mock, mock_api):
        ...
        order_book: OpenwareOrderBook = self.async_run_with_timeout(
    ...
    @aioresponses()
    @patch(
        "hummingbot.connector.exchange.openware.openware_api_order_book_data_source.OpenwareAPIOrderBookDataSource._sleep",
    ...
    def test_listen_for_trades_unrecognised(self, ws_connect_mock):
        ...
        self.assertTrue(self._is_logged("INFO",
                                        "Unrecognized message received from Centralex websocket: {'hbotusdttrades': {}}"))
    ...
    def test_listen_for_order_book_diff_unrecognised(self, ws_connect_mock, time_mock):
        ...
        self.assertTrue(self._is_logged("INFO",
                                        "Unrecognized message received from Centralex websocket: {'snapcracklepop': {}}"))
