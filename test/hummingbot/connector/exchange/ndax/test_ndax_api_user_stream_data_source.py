...
class NdaxAPIUserStreamDataSourceTests(IsolatedAsyncioWrapperTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.auth = NdaxAuth(uid=self.uid, api_key=self.api_key, secret_key=self.secret, account_name=self.username)
    ...
    def _authentication_response(self, authenticated: bool) -> str:
        ...
        message = {"m": 1, "i": 1, "n": CONSTANTS.AUTHENTICATE_USER_ENDPOINT_NAME, "o": json.dumps(payload)}
