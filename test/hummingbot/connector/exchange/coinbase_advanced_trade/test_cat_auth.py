...
class CoinbaseAdvancedTradeAuthTests(IsolatedAsyncioWrapperTestCase):
    ...
    async def test_get_current_server_time_ms_fuzzy(self):
        # Get the local time in seconds since the Unix epoch
    ...
    async def test_rest_authenticate_on_public_time(self):
    ...
    async def test__get_synced_timestamp_s_time_sync_methods_called(self):
    ...
    async def test__get_synced_timestamp_s_get_current_server_time_called(self):
    ...
    async def test__get_synced_timestamp_s_time_sync_return_value(self):
        server_time_ms = await get_current_server_time_ms()
    ...
    async def test__get_synced_timestamp_s(self):
