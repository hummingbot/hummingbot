...
class BtseUserStreamDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data_source = BtseAPIUserStreamDataSource(
            auth=BtseAuth(api_key="TEST_API_KEY", secret_key="TEST_SECRET", time_provider=self.mock_time_provider),
            domain=self.domain,
    ...
    @patch("hummingbot.connector.exchange.btse.btse_api_user_stream_data_source.BtseAPIUserStreamDataSource"
           "._ping_listen_key",
