...
class BtseExchangeTests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.exchange = BtseExchange(
            btse_api_key="testAPIKey",
            btse_api_secret="testSecret",
        ...
        BtseAPIOrderBookDataSource._trading_pair_symbol_map = {
            "com": bidict(
    ...
    def test_create_order_successfully(self, mock_api):
        ...
        self.assertEqual(BtseExchange.btse_order_type(OrderType.LIMIT), request_data["type"])
    ...
    def test_update_order_fills_request_parameters(self, mock_api):
        ...
        self.exchange._last_poll_timestamp = (self.exchange.current_timestamp -
                                              self.exchange.UPDATE_ORDER_STATUS_MIN_INTERVAL - 1)
        self.exchange._last_trades_poll_btse_timestamp = 10
        self.async_run_with_timeout(self.exchange._update_order_fills_from_trades())
