...
class BtseAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data_source = BtseAPIOrderBookDataSource(
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.btse.btse_api_order_book_data_source"
           ".BtseAPIOrderBookDataSource._sleep")
