...
class KrakenUtilTestCases(unittest.TestCase):
    ...
    def test_convert_to_exchange_trading_pair(self):
        ...
        self.assertEqual(self.ex_ws_trading_pair, utils.convert_to_exchange_trading_pair(self.ex_ws_trading_pair))
    ...
    def test_convert_from_exchange_trading_pair(self):
        ...
        self.assertEqual(self.trading_pair, utils.convert_from_exchange_trading_pair(self.ex_trading_pair,("XBTUSDT","ETHUSDT")))
