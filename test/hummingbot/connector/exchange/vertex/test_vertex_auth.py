...
class VertexAuthTests(TestCase):
    ...
    def test_sign_payload(self):
        order = Order(
            sender="0x2162Db26939B9EAF0C5404217774d166056d31B5",
            priceX18=26383000000000000000000,
            amount=2292000000000000000,
            expiration=1685989016166771694,
            nonce=1767924162661187978,
        )
        contract = "0xbf16e41fb4ac9922545bfc1500f67064dc2dcc3b"
        chain_id = "421613"
        expected_signature = "0x458cb49f9c20f3f2c8f57d229ca9f33fd23556b3d5c87dbe9366e9e09ef00c43632ef996f67434f55350a9241f4bff62da7055aaa889237d33e403b482e8abab1b"
        expected_digest = "0xaa4dadc6a1ed641eb46a22b1b58fd702e60392b8593e3fb29a5218f7f4010e69"
        signature, digest = self.auth.sign_payload(order, contract, chain_id)
        self.assertEqual(expected_signature, signature)
        self.assertEqual(expected_digest, digest)

    def test_generate_digest(self):
        signable_bytes = b"\x19\x01\xb0_\xd0\xc1Co\xf9K\xb2C$*S\x8f\xd78\xac\xc3\xdcdu\xf0\xfcY\x9d9\xac\xe7\xff/\xa6)\x1fp-\xfcL\x9d\xdf\xe8\xbb\xffe\x0bJIl\x14\x94\x89\xc9{\x9af\x97\xad2\x13\x8a1\xca\x89\xfa\xd3"
        expected_digest = "0xaa4dadc6a1ed641eb46a22b1b58fd702e60392b8593e3fb29a5218f7f4010e69"
