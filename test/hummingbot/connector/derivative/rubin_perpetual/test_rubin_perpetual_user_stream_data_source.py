...
class RubinPerpetualUserStreamDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    @patch(
        "hummingbot.connector.derivative.rubin_perpetual.rubin_perpetual_user_stream_data_source."
        "RubinPerpetualUserStreamDataSource._sleep"
    )
    ...
    async def test_ws_authentication_successful(self, ws_connect_mock):
        ...
        self.assertEqual("rubin14zzueazeh0hj67cghhf9jypslcf9sh2n5k6art/0", json_msgs[0]["id"])
