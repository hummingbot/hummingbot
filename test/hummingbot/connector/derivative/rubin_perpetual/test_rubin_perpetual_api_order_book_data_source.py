...
class RubinPerpetualAPIOrderBookDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data_source = RubinPerpetualAPIOrderBookDataSource(
            trading_pairs=[self.trading_pair],
    ...
    @aioresponses()
    @patch(
        "hummingbot.connector.derivative.rubin_perpetual.rubin_perpetual_api_order_book_data_source."
        "RubinPerpetualAPIOrderBookDataSource._time"
    )
    ...
    @patch(
        "hummingbot.connector.derivative.rubin_perpetual.rubin_perpetual_api_order_book_data_source."
        "RubinPerpetualAPIOrderBookDataSource._sleep"
    )
