...
from test.hummingbot.connector.derivative.rubin_perpetual.programmable_v4_client import ProgrammableV4Client
...
import hummingbot.connector.derivative.rubin_perpetual.rubin_perpetual_web_utils as web_utils
...
class RubinPerpetualDerivativeTests(AbstractPerpetualDerivativeTests.PerpetualDerivativeTests):
    @classmethod
    ...
    def balance_url(self):
        path = f"{CONSTANTS.PATH_SUBACCOUNT}/{self.rubin_perpetual_chain_address}/subaccountNumber/{self.subaccount_id}"
    ...
    def balance_request_mock_response_only_quote(self):
        mock_response = {
            'subaccount':
                {
                    'address': 'rubin1nwtryq2dxy3a3wr5zyyvdsl5t40xx8qgvk6cm3',  # noqa: mock
                    'subaccountNumber': 0,
                    'equity': '10000',
    ...
    def balance_event_websocket_update(self):
        mock_response = {
            ...
            'id': 'rubin1nwtryq2dxy3a3wr5zyyvdsl5t40xx8qgvk6cm3/0', 'contents': {  # noqa: mock
                'subaccount': {
                    'address': 'rubin1nwtryq2dxy3a3wr5zyyvdsl5t40xx8qgvk6cm3', 'subaccountNumber': 0,  # noqa: mock
    ...
    def create_exchange_instance(self):
        exchange = RubinPerpetualDerivative(
            rubin_perpetual_secret_phrase=self.rubin_perpetual_secret_phrase,
            rubin_perpetual_chain_address=self.rubin_perpetual_chain_address,
    ...
    def validate_order_status_request(self, order: InFlightOrder, request_call: RequestCall):
        ...
        if request_params is not None:
            self.assertEqual(self.rubin_perpetual_chain_address, request_params["address"])
    ...
    def configure_partially_filled_order_status_response(
        ...
        # Rubin has no partial fill status
        raise NotImplementedError
    ...
    @patch("hummingbot.connector.derivative.rubin_perpetual.rubin_perpetual_api_order_book_data_source."
           "RubinPerpetualAPIOrderBookDataSource._next_funding_time")
