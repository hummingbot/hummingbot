...
class LighterPerpetualDerivativeTests(AbstractPerpetualDerivativeTests.PerpetualDerivativeTests):
    ...
    def test_supported_position_modes(self):
        linear_connector = LighterPerpetualDerivative(
            lighter_perpetual_api_key=self.api_key,
            lighter_perpetual_api_secret=self.api_secret,
            use_vault=self.use_vault,
            trading_pairs=[self.trading_pair],
    ...
    @patch(
        "hummingbot.connector.derivative.lighter_perpetual.lighter_perpetual_api_order_book_data_source.LighterPerpetualAPIOrderBookDataSource._next_funding_time")
