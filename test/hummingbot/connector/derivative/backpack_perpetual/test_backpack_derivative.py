...
class BackpackDerivativeTests(AbstractPerpetualDerivativeTests.PerpetualDerivativeTests):
    @classmethod
    ...
    def create_exchange_instance(self):
        exchange = BackpackDerivative(
            backpack_api_key=self.api_key,
            backpack_secret_key=self.api_secret,
            backpack_passphrase=self.passphrase,
    ...
    def test_user_stream_balance_update(self):
        non_linear_connector = BackpackDerivative(
            backpack_api_key=self.api_key,
            backpack_secret_key=self.api_secret,
    ...
    def test_supported_position_modes(self):
        linear_connector = BackpackDerivative(
            backpack_api_key=self.api_key,
            backpack_secret_key=self.api_secret,
            trading_pairs=[self.trading_pair],
        )
    ...
    def test_update_order_status_when_order_has_not_changed_and_one_partial_fill(self, mock_api):
        # Backpack has no partial fill status
        pass
