...
class BackpackPerpetualDerivativeUnitTest(IsolatedAsyncioWrapperTestCase):
    ...
    async def test_update_balances(self, mock_api):
        ...
        response = {self.quote_asset: {"available": "100.5", "locked": "50.5", "staked": "0"}}
    ...
    async def test_update_balances_with_asset_removal(self, mock_api):
        ...
        response = {
            self.quote_asset: {"available": "100.5", "locked": "50.5", "staked": "0"},
            self.base_asset: {"available": "200.0", "locked": "0", "staked": "0"},
        }
        ...
        response2 = {self.quote_asset: {"available": "100.5", "locked": "50.5", "staked": "0"}}
