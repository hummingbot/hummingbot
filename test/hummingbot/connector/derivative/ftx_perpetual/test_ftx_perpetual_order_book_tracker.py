...
class FtxPerpetualOrderBookTrackerUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        # Simulate start()
        self.tracker._order_books[self.trading_pair] = FtxPerpetualOrderBook()
    ...
    def test_exchange_name(self):
        self.assertEqual("ftx_perpetual", self.tracker.exchange_name)
    ...
    def test_track_single_book_snapshot_message_with_past_diffs(self):
        past_diff_msg: OrderBookMessage = FtxPerpetualOrderBook.diff_message_from_exchange(
            msg={
                "market": "COINALPHA-PERP",
                "lastUpdateId": 1,
                "data": {
    ...
    def test_track_single_book_diff_message(self):
        diff_msg: OrderBookMessage = FtxPerpetualOrderBook.diff_message_from_exchange(
            msg={
                "market": "COINALPHA-PERP",
                "lastUpdateId": 1,
                "data": {
