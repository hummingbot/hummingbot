...
class FtxPerpetualAuthTests(TestCase):
    ...
    @patch("hummingbot.connector.derivative.ftx_perpetual.ftx_perpetual_auth.FtxPerpetualAuth._time")
    ...
    def test_websocket_login_parameters(self, time_mock):
        ...
        self.auth = FtxPerpetualAuth(api_key=self.api_key, secret_key=secret, subaccount_name=self.subaccount_name)
