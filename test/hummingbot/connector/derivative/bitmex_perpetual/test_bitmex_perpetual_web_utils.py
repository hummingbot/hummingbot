...
from hummingbot.connector.derivative.bitmex_perpetual.bitmex_perpetual_web_utils import BitmexPerpetualRESTPreProcessor
from hummingbot.core.web_assistant.connections.data_types import RESTMethod, RESTRequest
from hummingbot.core.web_assistant.web_assistants_factory import WebAssistantsFactory


class BitmexPerpetualWebUtilsUnitTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.pre_processor = BitmexPerpetualRESTPreProcessor()
    ...
    def test_bitmex_perpetual_rest_pre_processor_post_request(self):
        request: RESTRequest = RESTRequest(
