...
class AbstractPerpetualDerivativeTests:
    ...
    class PerpetualDerivativeTests(AbstractExchangeConnectorTests.ExchangeConnectorTests):
        ...
        def test_estimated_fee_calculation(self):
            ...
            expected_fee = TradeFeeBase.new_spot_fee(
                fee_schema=fee_schema,
                trade_type=TradeType.BUY,
                percent=fee_schema.maker_percent_fee_decimal,
                percent_token=fee_schema.percent_fee_token,
                flat_fees=fee_schema.maker_fixed_fees,
            )
            ...
            expected_fee = TradeFeeBase.new_spot_fee(
                fee_schema=fee_schema,
                trade_type=TradeType.BUY,
                percent=fee_schema.taker_percent_fee_decimal,
                percent_token=fee_schema.percent_fee_token,
                flat_fees=fee_schema.taker_fixed_fees,
            )
