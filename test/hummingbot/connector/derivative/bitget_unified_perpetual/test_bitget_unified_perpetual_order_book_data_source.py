...
class BitgetUnifiedPerpetualAPIOrderBookDataSourceTests(IsolatedAsyncioWrapperTestCase):
    """Test case for BitgetUnifiedPerpetualAPIOrderBookDataSource."""
    ...
    def setUp(self) -> None:
        ...
        self.data_source = BitgetUnifiedPerpetualAPIOrderBookDataSource(
            trading_pairs=[self.trading_pair],
    ...
    async def test_listen_for_subscriptions_for_usdc_product_type_pair(
        ...
        local_data_source = BitgetUnifiedPerpetualAPIOrderBookDataSource(
