...
class TestBitmartPerpetualCandles(TestCandlesBase):
    ...
    def get_fetch_candles_data_mock(self):
        return [
            [1747267200, "103457.8", "103509.9", "103442.5", "103504.3", "147.548", 0.0, 0.0, 0.0, 0.0],
            [1747267500, "103504.3", "103524", "103462.9", "103499.7", "83.616", 0.0, 0.0, 0.0, 0.0],
            [1747267800, "103504.3", "103524", "103442.9", "103499.7", "83.714", 0.0, 0.0, 0.0, 0.0],
            [1747268100, "103504.3", "103544", "103462.9", "103494.7", "83.946", 0.0, 0.0, 0.0, 0.0],
        ]
    ...
    def get_candles_ws_data_mock_1(self):
        return {
            "data": {
                "items": [{"c": "1.157", "h": "1.158", "l": "1.1509", "o": "1.1517", "ts": 1747425900, "v": "29572"}],
                "symbol": "WLDUSDT",
            },
    ...
    def get_candles_ws_data_mock_2(self):
        return {
            "data": {
                "items": [{"c": "1.157", "h": "1.158", "l": "1.1509", "o": "1.157", "ts": 1747426200, "v": "23472"}],
                "symbol": "WLDUSDT",
            },
            "group": "futures/klineBin5m:WLDUSDT",
        }
