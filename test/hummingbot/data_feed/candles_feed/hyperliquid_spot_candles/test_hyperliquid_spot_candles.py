...
import hummingbot.data_feed.candles_feed.hyperliquid_spot_candles.constants as CONSTANTS
...
class TestHyperliquidSpotC0andles(TestCandlesBase):
    ...
    def test_check_network(self, mock_api):
        ...
        mock_api.post(url=url, payload=json.dumps(self.get_universe_data_mock()))
        self.assertEqual(self.ev_loop.run_until_complete(self.data_feed.check_network()), NetworkStatus.CONNECTED)
        self.assertEqual(self.data_feed._universe, json.dumps(self.get_universe_data_mock()))
