...
class TestBackpackPerpetualCandles(TestCandlesBase):
    __test__ = True
    level = 0
    ...
    def setUp(self) -> None:
        super().setUp()
        self.data_feed = BackpackPerpetualCandles(trading_pair=self.trading_pair, interval=self.interval)
    ...
    def test_empty_ws_candle_is_skipped(self):
        empty = {"data": {"e": "kline", "s": "BTC_USDC_PERP", "t": "2024-06-18T00:00:00", "T": "2024-06-18T01:00:00",
