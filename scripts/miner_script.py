...
class MinerScriptV1(ScriptStrategyBase):
    ...
    order_levels = [
        OrderLevel(level=0, side=TradeType.BUY, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(0.2), order_refresh_time=60 * 5,
                   cooldown_time=1, triple_barrier_conf=triple_barrier_conf),
        ...
        OrderLevel(level=3, side=TradeType.BUY, order_amount_usd=Decimal("7"),
                   ...
                   cooldown_time=15, triple_barrier_conf=triple_barrier_conf),
        OrderLevel(level=4, side=TradeType.BUY, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(0.6), order_refresh_time=60 * 5,
                   cooldown_time=15, triple_barrier_conf=triple_barrier_conf),
        OrderLevel(level=5, side=TradeType.BUY, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(0.7), order_refresh_time=60 * 5,
                   cooldown_time=15, triple_barrier_conf=triple_barrier_conf),
        OrderLevel(level=6, side=TradeType.BUY, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(0.8), order_refresh_time=60 * 5,
                   cooldown_time=15, triple_barrier_conf=triple_barrier_conf),
        OrderLevel(level=7, side=TradeType.BUY, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(0.9), order_refresh_time=60 * 5,
                   cooldown_time=15, triple_barrier_conf=triple_barrier_conf),
        OrderLevel(level=8, side=TradeType.BUY, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(1.0), order_refresh_time=60 * 5,
                   cooldown_time=15, triple_barrier_conf=triple_barrier_conf),

        OrderLevel(level=0, side=TradeType.SELL, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(0.2), order_refresh_time=60 * 5,
                   cooldown_time=1, triple_barrier_conf=triple_barrier_conf),
        ...
        OrderLevel(level=3, side=TradeType.SELL, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(0.5), order_refresh_time=60 * 5,
                   cooldown_time=15, triple_barrier_conf=triple_barrier_conf),
        OrderLevel(level=4, side=TradeType.SELL, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(0.6), order_refresh_time=60 * 5,
                   cooldown_time=15, triple_barrier_conf=triple_barrier_conf),
        OrderLevel(level=5, side=TradeType.SELL, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(0.7), order_refresh_time=60 * 5,
                   cooldown_time=15, triple_barrier_conf=triple_barrier_conf),
        OrderLevel(level=6, side=TradeType.SELL, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(0.8), order_refresh_time=60 * 5,
                   cooldown_time=15, triple_barrier_conf=triple_barrier_conf),
        OrderLevel(level=7, side=TradeType.SELL, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(0.9), order_refresh_time=60 * 5,
                   cooldown_time=15, triple_barrier_conf=triple_barrier_conf),
        OrderLevel(level=8, side=TradeType.SELL, order_amount_usd=Decimal("7"),
                   spread_factor=Decimal(1.0), order_refresh_time=60 * 5,
                   cooldown_time=15, triple_barrier_conf=triple_barrier_conf),
    ]
    controllers = {}
