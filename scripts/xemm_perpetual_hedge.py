...
class XEMMPerpetualHedge(ScriptStrategyBase):
    ...
    def on_tick(self):
        ...
        self.place_buy_order_if_none(active_orders, taker_sell_result)
        self.place_sell_order_if_none(active_orders, taker_buy_result)
        self.cancel_orders_if_invalidated(taker_buy_result, taker_sell_result)

    def place_buy_order_if_none(self, active_orders: list, taker_sell_result: ClientOrderBookQueryResult):
