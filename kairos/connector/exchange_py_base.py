...
from kairos.connector.client_order_tracker import ClientOrderTracker
from kairos.connector.constants import MINUTE, TWELVE_HOURS, s_decimal_0, s_decimal_NaN
...
from kairos.core.data_type.user_stream_tracker import UserStreamTracker
...
from kairos.core.utils.async_utils import safe_ensure_future, safe_gather
...
class ExchangePyBase(ExchangeBase, ABC):
    ...
    def logger(cls) -> KairosLogger:
        if cls._logger is None:
            cls._logger = logging.getLogger(KairosLogger.logger_name_for_class(cls))
        return cls._logger
