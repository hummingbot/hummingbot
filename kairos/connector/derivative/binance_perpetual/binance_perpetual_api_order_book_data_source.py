...
from kairos.core.data_type.funding_info import FundingInfo, FundingInfoUpdate
...
from kairos.core.web_assistant.connections.data_types import WSJSONRequest
...
if TYPE_CHECKING:
    from kairos.connector.derivative.binance_perpetual.binance_perpetual_derivative import (
        BinancePerpetualDerivative,
    )


class BinancePerpetualAPIOrderBookDataSource(PerpetualAPIOrderBookDataSource):
    _bpobds_logger: Optional[KairosLogger] = None
