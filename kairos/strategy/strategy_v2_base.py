...
from kairos.core.data_type.common import MarketDict, PositionMode
from kairos.core.data_type.limit_order import LimitOrder
from kairos.core.event.events import OrderType, PositionAction
...
from kairos.remote_iface.mqtt import ETopicPublisher
from kairos.strategy.market_trading_pair_tuple import MarketTradingPairTuple
from kairos.strategy.strategy_py_base import StrategyPyBase
...
def _get_executor_orchestrator_class():
    ...
    if ExecutorOrchestrator is None:
        from kairos.strategy_v2.executors.executor_orchestrator import ExecutorOrchestrator as _cls
...
class StrategyV2Base(StrategyPyBase):
    ...
    def start(self, clock: Clock, timestamp: float) -> None:
        ...
        if KairosApplication.main_application()._mqtt is not None:
