...
from kairos.core.event.events import MarketEvent, AccountEvent
...
from kairos.core.data_type.common import OrderType, PositionAction
from kairos.strategy.order_tracker import OrderTracker
from kairos.connector.derivative_base import DerivativeBase
...
cdef class StrategyBase(TimeIterator):
    ...
    def notify_hb_app(self, msg: str):
        ...
        KairosApplication.main_application().notify(msg)
