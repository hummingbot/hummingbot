...
from kairos.core.api_throttler.async_request_context_base import AsyncRequestContextBase
from kairos.core.api_throttler.data_types import RateLimit, TaskLog
from kairos.logger.logger import KairosLogger
...
class AsyncThrottlerBase(ABC):
    ...
    def _client_config_map(self):
        from kairos.client.kairos_application import KairosApplication  # avoids circular import

        return KairosApplication.main_application().client_config_map
