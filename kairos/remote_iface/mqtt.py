...
from kairos import get_logging_conf
...
mqtts_logger: KairosLogger = None
...
class MQTTMarketEventForwarder:
    ...
    def logger(cls) -> KairosLogger:
        ...
        if mqtts_logger is None:  # pragma: no cover
            mqtts_logger = KairosLogger(__name__)
        return mqtts_logger
...
class MQTTGateway:
    ...
    def __init__(self,
        ...
        self._hb_app: "KairosApplication" = hb_app
    ...
    def remove_log_handler(self, logger: KairosLogger):
        logger.removeHandler(self._logh)

    def add_log_handler(self, logger: KairosLogger):
