...
from kairos.client.ui.interface_utils import start_process_monitor, start_timer, start_trade_monitor
from kairos.client.ui.layout import (
    create_input_field,
    create_live_field,
    create_log_field,
    create_log_toggle,
...
class KairosCLI(PubSub):
    ...
    def handle_tab_command(self, app: "KairosApplication", command_name: str, kwargs: Dict[str, Any]):
        ...
        self.display_tab_output(cmd_tab, app, kwargs)
    ...
    def display_tab_output(self,
        ...
        if threading.current_thread() != threading.main_thread():
            app.ev_loop.call_soon_threadsafe(self.display_tab_output, command_tab, app, kwargs)
            return
        command_tab.task = safe_ensure_future(command_tab.tab_class.display(command_tab.output_field, app,
                                                                            **kwargs))
