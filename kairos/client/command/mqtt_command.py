...
class MQTTCommand:
    ...
    def mqtt_start(self,  # type: KairosApplication
                   timeout: float = 30.0
                   ):
    ...
    def mqtt_stop(self,  # type: KairosApplication
                  ):
        if threading.current_thread() != threading.main_thread():
    ...
    def mqtt_restart(self,  # type: KairosApplication
                     timeout: float = 30.0
                     ):
        if threading.current_thread() != threading.main_thread():
    ...
    async def start_mqtt_async(self,  # type: KairosApplication
                               timeout: float = 30.0
                               ):
    ...
    async def stop_mqtt_async(self,  # type: KairosApplication
                              ):
        if self._mqtt is not None:
            try:
                self._mqtt.stop()
    ...
    async def restart_mqtt_async(self,  # type: KairosApplication
                                 timeout: float = 2.0
                                 ):
