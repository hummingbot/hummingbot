...
from kairos.client.config.client_config_map import AutofillImportEnum
...
from kairos.client.settings import CONF_PREFIX, STRATEGIES_CONF_DIR_PATH, required_exchanges
...
class ImportCommand:
    ...
    def import_command(self,  # type: KairosApplication
                       file_name):
    ...
    async def import_config_file(self,  # type: KairosApplication
                                 file_name):
    ...
    async def prompt_a_file_name(self  # type: KairosApplication
                                 ):
