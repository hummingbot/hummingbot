...
RESOURCES_PATH = "kairos/client/command/silly_resources/"


class SillyCommands:

    def be_silly(self,  # type: KairosApplication
    ...
    async def silly_jack(self,  # type: KairosApplication
                         ):
    ...
    async def silly_roger(self,  # type: KairosApplication
                          ):
        self.placeholder_mode = True
        self.app.hide_input = True
        for _ in range(0, 3):
    ...
    async def silly_victor(self,  # type: KairosApplication
                           ):
        self.placeholder_mode = True
        self.app.hide_input = True
    ...
    async def silly_rein(self,  # type: KairosApplication
                         ):
        self.placeholder_mode = True
        self.app.hide_input = True
        for _ in range(0, 2):
    ...
    async def silly_dennis(self,  # type: KairosApplication
                           ):
        self.placeholder_mode = True
        self.app.hide_input = True
