...
from kairos.client.settings import SCRIPT_STRATEGY_CONF_DIR_PATH, STRATEGIES_CONF_DIR_PATH, required_exchanges
from kairos.client.ui.completer import load_completer
from kairos.core.utils.async_utils import safe_ensure_future
from kairos.exceptions import InvalidController, InvalidScriptModule
...
class CreateCommand:
    def create(self,  # type: KairosApplication
    ...
    async def prompt_for_controller_config(self,  # type: KairosApplication
                                           controller_name: str):
        try:
    ...
    async def prompt_for_configuration_v2(self,  # type: KairosApplication
    ...
    async def prompt_new_file_name(self,  # type: KairosApplication
                                   strategy: str,
