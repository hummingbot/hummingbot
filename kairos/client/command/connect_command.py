...
from kairos.client.settings import AllConnectorSettings, connectable_exchange_names
...
class ConnectCommand:
    def connect(self,  # type: KairosApplication
                option: str):
        if option is None:
    ...
    async def connect_exchange(self,  # type: KairosApplication
                               connector_name):
    ...
    async def show_connections(self  # type: KairosApplication
                               ):
    ...
    async def connection_df(self  # type: KairosApplication
                            ):
        await Security.wait_til_decryption_done()
