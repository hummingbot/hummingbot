...
class TabBase(metaclass=ABCMeta):
    ...
    def get_command_arguments(cls) -> Dict[str, Dict[str, Any]]:
        """
        Returns a dictionary of command argument and all its properties. See kairos.client.ui.parser for examples.
        """
    ...
    @classmethod
    @abstractmethod
    async def display(cls, output_field: CustomTextArea, app: "KairosApplication", **kwargs):
        """
