...
from kairos.client.command import __all__ as commands
...
from kairos.client.settings import CLIENT_CONFIG_PATH
from kairos.client.tab import __all__ as tab_classes
from kairos.client.tab.data_types import CommandTab
from kairos.client.ui.completer import load_completer
from kairos.client.ui.kairos_cli import KairosCLI
from kairos.client.ui.keybindings import load_key_bindings
from kairos.client.ui.parser import ThrowingArgumentParser, load_parser
...
class KairosApplication(*commands):
    KILL_TIMEOUT = 20.0
    APP_WARNING_EXPIRY_DURATION = 3600.0
    APP_WARNING_STATUS_LIMIT = 6

    _main_app: Optional["KairosApplication"] = None
    ...
    @classmethod
    def main_application(cls, client_config_map: Optional[ClientConfigAdapter] = None, headless_mode: bool = False) -> "KairosApplication":
        if cls._main_app is None:
            cls._main_app = KairosApplication(client_config_map=client_config_map, headless_mode=headless_mode)
    ...
    def init_command_tabs(self) -> Dict[str, CommandTab]:
        ...
        populated later on by KairosCLI
        """
