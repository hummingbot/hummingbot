...
from kairos.model import get_declarative_base
from kairos.model.metadata import Metadata as LocalMetadata
...
class SQLConnectionManager(TransactionBase):
    _scm_logger: Optional[KairosLogger] = None
    ...
    def __init__(self,
        ...
        if connection_type is SQLConnectionType.TRADE_FILLS:
            ...
            # See: `kairos/market/markets_recorder.py`, at line 213.
    ...
    def check_and_migrate_db(self, client_config_map: "ClientConfigAdapter"):
        from kairos.model.db_migration.migrator import Migrator
