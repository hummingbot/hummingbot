...
from kairos.cli.commands._common import one_type, read_json_object_from_stdin
from kairos.cli.output import ExitCode, echo, fail, render_kv
...
def _resolve_strategy_type(strategy: str, v1: bool, v2: bool, controller: bool) -> str:
    ...
    from kairos.cli.strategy_configs import STRATEGY_TYPES, available_sources, matching_strategy_types
