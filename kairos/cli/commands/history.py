...
from kairos.cli.output import echo, render_table
...
def history(
    ...
    from kairos.cli.commands._common import resolve_db_for_command
    from kairos.cli.data import get_trades
    ...
    if name is None:
        ...
        if running and not balances:
            from kairos.cli.commands.status import _request_fresh_snapshot
