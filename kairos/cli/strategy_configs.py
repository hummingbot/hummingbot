...
# Type ids match the folder vocabulary: v1-strategy (kairos/strategy + conf/strategies),
...
def available_v1_strategies() -> List[str]:
    ...
    from kairos import get_strategy_list
...
def describe_strategy(stype: str, source: str, scaffold_id: bool = True) -> Tuple[dict, List[str], Set[str]]:
    ...
    """
    from kairos.client.config.config_helpers import get_strategy_config_map, get_strategy_pydantic_config_cls
