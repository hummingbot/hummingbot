...
class ProgressiveOrderPNLProtocol(
    ExecutorProtocol, ProgressiveProtocol, OrderManagementProtocol, PNLCalculatorProtocol
):
    pass
...
class OrderExecutionProtocol(Protocol):
    ...
    def place_partial_close_order(
        self, close_type: CloseType, price: Decimal = Decimal("NaN"), amount_to_close: Decimal = Decimal("NaN")
    ) -> None: ...
