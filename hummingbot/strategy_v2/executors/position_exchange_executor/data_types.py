...
class TripleBarrierConfig(BaseModel):
    ...
    take_profit_order_type: OrderType = OrderType.TAKE_PROFIT
    stop_loss_order_type: OrderType = OrderType.STOP_LOSS
...
class PositionExchangeExecutorConfig(ExecutorConfigBase):
