...
def default_strategy_registry() -> Dict[str, StrategyCandidate]:
    ...
    candidates = [
        ...
        StrategyCandidate(
            ...
            description="SuperTrend adapter registered; remains shadow until validation gates pass.",
            priority=40,
            enabled=False,
        ),
        StrategyCandidate(
        ...
        StrategyCandidate(
            ...
            executor_type="position_executor",
            supported_regimes=[MarketRegime.RANGE_LOW_VOL, MarketRegime.RANGE_HIGH_VOL],
            description="PMM Mister adapter registered; remains shadow until validation gates pass.",
            priority=45,
            enabled=False,
        ),
        StrategyCandidate(
        ...
        StrategyCandidate(
            ...
            executor_type="position_executor",
            supported_regimes=[MarketRegime.ARBITRAGE],
            description="Funding arbitrage adapter registered; remains shadow until validation gates pass.",
            priority=70,
            enabled=False,
        ),
        StrategyCandidate(
