...
class CreateExecutorAction(ExecutorAction):
    ...
    """
    executor_config: Union[PositionExecutorConfig, PositionExchangeExecutorConfig, DCAExecutorConfig, XEMMExecutorConfig, ArbitrageExecutorConfig, TWAPExecutorConfig]
