...
class VeridexOrderBookMessage(OrderBookMessage):
    def __new__(
        cls,
        message_type: OrderBookMessageType,
        content: Dict[str, any],
        ...
        **kwargs,
        ...
        return super(VeridexOrderBookMessage, cls).__new__(
            cls, message_type, content, timestamp=timestamp, *args, **kwargs
        )
    ...
    @property
    def asks(self) -> List[OrderBookRow]:
        raise NotImplementedError("Veridex order book messages have different semantics.")
