...
class HitbtcOrderBookMessage(OrderBookMessage):
    ...
    @property
    def asks(self) -> List[OrderBookRow]:
        raise NotImplementedError("Hitbtc order book messages have different semantics.")
...
class BitcoinComOrderBookMessage(OrderBookMessage):
    ...
    @property
    def asks(self) -> List[OrderBookRow]:
        raise NotImplementedError("BitcoinCom order book messages have different semantics.")
