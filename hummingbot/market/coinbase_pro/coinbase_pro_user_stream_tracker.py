...
<<<<<<< HEAD:hummingbot/market/coinbase_pro/coinbase_pro_user_stream_tracker.py
...
>>>>>>> resolved conflict in settings.py:hummingbot/market/bitroyal/bitroyal_user_stream_tracker.py
