...
cdef class BinanceMarket(MarketBase):
    ...
    cdef object c_get_fee(self,
        ...
        if order_type is OrderType.LIMIT and trade_fees_config_map["binance_maker_fee"].value is not None:
            return TradeFee(percent=trade_fees_config_map["binance_maker_fee"].value)
        if order_type is OrderType.MARKET and trade_fees_config_map["binance_taker_fee"].value is not None:
            return TradeFee(percent=trade_fees_config_map["binance_taker_fee"].value)
