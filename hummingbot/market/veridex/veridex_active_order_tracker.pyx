...
VeridexOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]


cdef class VeridexActiveOrderTracker:
    def __init__(self,
                 active_asks: VeridexOrderBookTrackingDictionary = None,
                 active_bids: VeridexOrderBookTrackingDictionary = None,
    ...
    @property
    def active_asks(self) -> VeridexOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> VeridexOrderBookTrackingDictionary:
