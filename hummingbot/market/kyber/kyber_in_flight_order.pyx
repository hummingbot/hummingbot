...
cdef class KyberInFlightOrder(InFlightOrderBase):
    def __init__(self,
                 client_order_id: str,
    ...
    def is_failure(self) -> bool:
        # Kyber does not have any 'expiry" or "rejected" order statuses
    ...
    def from_json(cls, data: Dict[str, Any]) -> InFlightOrderBase:
        cdef:
            KyberInFlightOrder retval = KyberInFlightOrder(
