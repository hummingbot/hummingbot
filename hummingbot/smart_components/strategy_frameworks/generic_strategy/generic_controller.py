    ...
    def to_format_status(self) -> list:
        ...
        if executor_handler_report is not None:
            ...
            if not active_dca_executors_df.empty:
                ...
                dca_columns_to_show = ["status", "trading_pair", "side", "current_pnl", "max_amount", "min_price", "max_price", "target_position_average_price", "current_position_average_price", "leverage"]
