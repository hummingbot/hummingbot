...
global_config_map = {
    ...
    "asset_restriction_enabled":
        ConfigVar(key="asset_restriction_enabled",
                  prompt="Would you like to restrict the assets Hummingbot can access? (Yes/No) >>> ",
                  type_str="bool",
                  default=False,
                  validator=validate_bool),
    "asset_restriction":
        ConfigVar(key="asset_restriction",
                  prompt="Enter asset restriction settings (Input must be a valid json: "
                         "e.g. [[\"ETH\", 10.0], [\"USDC\", 100]]) >>> ",
                  type_str="json",
                  default=[],
