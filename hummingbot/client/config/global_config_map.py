...
<<<<<<< HEAD
    ...
    "telegram_chat_id":                 ConfigVar(key="telegram_chat_id",
                                                  ...
                                                  required_if=lambda: False),
    "exchange_rate_default_data_feed":  ConfigVar(key="exchange_rate_default_data_feed",
                                                  prompt="What is your default exchange rate data feed name? >>> ",
                                                  required_if=lambda: False,
                                                  default="coin_gecko_api"),
=======
    "binance_api_key": ConfigVar(
        key="binance_api_key",
        prompt="Enter your Binance API key >>> ",
        required_if=using_exchange("binance"),
        is_secure=True,
    ),
    "binance_api_secret": ConfigVar(
        key="binance_api_secret",
        prompt="Enter your Binance API secret >>> ",
        required_if=using_exchange("binance"),
        is_secure=True,
    ),
    "coinbase_pro_api_key": ConfigVar(
        key="coinbase_pro_api_key",
        prompt="Enter your Coinbase API key >>> ",
        required_if=using_exchange("coinbase_pro"),
        is_secure=True,
    ),
    "coinbase_pro_secret_key": ConfigVar(
        key="coinbase_pro_secret_key",
        prompt="Enter your Coinbase secret key >>> ",
        required_if=using_exchange("coinbase_pro"),
        is_secure=True,
    ),
    "coinbase_pro_passphrase": ConfigVar(
        key="coinbase_pro_passphrase",
        prompt="Enter your Coinbase passphrase >>> ",
        required_if=using_exchange("coinbase_pro"),
        is_secure=True,
    ),
    "huobi_api_key": ConfigVar(
        key="huobi_api_key", prompt="Enter your Huobi API key >>> ", required_if=using_exchange("huobi"), is_secure=True
    ),
    "huobi_secret_key": ConfigVar(
        key="huobi_secret_key",
        prompt="Enter your Huobi secret key >>> ",
        required_if=using_exchange("huobi"),
        is_secure=True,
    ),
    "idex_api_key": ConfigVar(
        key="idex_api_key", prompt="Enter your IDEX API key >>> ", required_if=using_exchange("idex"), is_secure=True
    ),
    ...
    "bamboo_relay_use_coordinator": ConfigVar(
        key="bamboo_relay_use_coordinator",
        prompt="Would you like to use the Bamboo Relay Coordinator (y/n) >>> ",
        required_if=using_exchange("bamboo_relay"),
        type_str="bool",
        default=True,
    ),
    "bamboo_relay_pre_emptive_soft_cancels": ConfigVar(
        key="bamboo_relay_pre_emptive_soft_cancels",
    ...
    # Whether or not to invoke cancel_all on exit if marketing making on a open order book DEX (e.g. Radar Relay)
    "on_chain_cancel_on_exit": ConfigVar(
        key="on_chain_cancel_on_exit",
        prompt="Would you like to cancel transactions on chain if using an " "open order books exchanges? >>> ",
        required_if=lambda: False,
        type_str="bool",
        default=False,
    ),
    "exchange_rate_conversion": ConfigVar(
        key="exchange_rate_conversion",
        prompt="Enter your custom exchange rate conversion settings >>> ",
        required_if=lambda: False,
        type_str="list",
        default=[
    ...
    "exchange_rate_fetcher": ConfigVar(
        key="exchange_rate_fetcher",
        prompt="Enter your custom exchange rate fetcher settings >>> ",
        required_if=lambda: False,
        type_str="list",
        default=[["ETH", "coin_gecko_api"], ["DAI", "coin_gecko_api"]],
    ),
    ...
    "kill_switch_rate": ConfigVar(
        ...
        prompt="At what profit/loss rate would you like the bot to " "stop? (e.g. -0.05 equals 5 percent loss) >>> ",
        type_str="float",
        default=-1,
        required_if=lambda: global_config_map["kill_switch_enabled"].value,
    ),
