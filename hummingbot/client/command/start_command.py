...
class StartCommand:
    ...
    def start(self,  # type: HummingbotApplication
        ...
        asyncio_ensure_future(self.start_market_making(strategy_name), loop=self.ev_loop)
    ...
    async def start_market_making(self,  # type: HummingbotApplication
        ...
        try:
            ...
            self.strategy_task: asyncio.Task = asyncio_ensure_future(self._run_clock(), loop=self.ev_loop)
