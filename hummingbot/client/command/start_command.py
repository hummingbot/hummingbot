...
class StartCommand(GatewayChainApiManager):
    ...
    async def start_market_making(self,  # type: HummingbotApplication
        ...
        try:
            ...
            strategy_overriding_tick = self.client_config_map.strategy_update_tick if self.client_config_map.strategy_update_tick != self.clock.tick_size else 0.0
            ...
            if self.strategy:
                ...
                self.strategy._set_overriding_tick(strategy_overriding_tick)
            try:
            ...
            if self._pmm_script_iterator is not None:
                ...
                self._pmm_script_iterator._set_overriding_tick(strategy_overriding_tick)
