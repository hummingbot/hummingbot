...
def load_parser(hummingbot) -> ThrowingArgumentParser:
    ...
    start_parser.add_argument(
        "--restore", default=False, action="store_true", dest="restore", help="Restore and maintain any active orders."
    )
    ...
    open_orders_parser.add_argument(
        ...
        action="store_true",
        dest="full_report",
        help="Show full report with size comparison",
    )
    ...
    trades_parser.add_argument(
        "-d", "--days", type=float, default=1.0, dest="days", help="How many days in the past (can be decimal value)"
    )
    trades_parser.add_argument("-m", "--market", default=None, dest="market", help="The market you want to see trades.")
    trades_parser.add_argument(
        "-o",
        "--open_order_markets",
        default=False,
        action="store_true",
        dest="open_order_markets",
        help="See trades from current open order markets.",
    )
    ...
    pnl_parser.add_argument("-m", "--market", default=None, dest="market", help="The market you want to see trades.")
    pnl_parser.add_argument(
        "-o",
        "--open_order_markets",
        default=False,
        action="store_true",
        dest="open_order_markets",
        help="See PnL from current open order markets.",
    )
    ...
    gateway_parser.add_argument(
        "option", nargs="?", choices=("update", "list-configs", "generate_certs"), help="Gateway configuration choices"
    )
    ...
    exit_parser.add_argument(
        ...
        "--suspend",
        action="store_true",
        help="Force exit without cancelling outstanding orders",
        default=False,
    )
    ...
    order_book_parser.add_argument(
    ...
    rate_parser.add_argument(
        "-p", "--pair", default=None, dest="pair", help="The market trading pair you want to see rate."
    )
    rate_parser.add_argument("-t", "--token", default=None, dest="token", help="The token you want to see its value.")
