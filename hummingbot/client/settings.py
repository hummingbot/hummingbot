...
GLOBAL_CONFIG_PATH = realpath(join(__file__, "../../../conf/conf_global.yml"))
# GLOBAL_CONFIG_PATH = "conf/conf_global.yml"
TRADE_FEES_CONFIG_PATH = realpath(join(__file__, "../../../conf/conf_fee_overrides.yml"))
...
CONF_FILE_PATH = realpath(join(__file__, "../../../conf/"))
# CONF_FILE_PATH = "conf/"
CONF_PREFIX = "conf_"
