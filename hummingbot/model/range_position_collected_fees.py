...
class RangePositionCollectedFees(HummingbotBase):
    ...
    __table_args__ = (Index("rpf_id_index", "token_id", "config_file_path"),)
    ...
    def __repr__(self) -> str:
        return (
            f"RangePositionCollectedFees(id={self.id}, config_file_path='{self.config_file_path}', strategy='{self.strategy}', "
