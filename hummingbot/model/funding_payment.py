...
class FundingPayment(HummingbotBase):
    ...
    __table_args__ = (
        Index("fp_config_timestamp_index", "config_file_path", "timestamp"),
        Index("fp_market_trading_pair_timestamp_index", "market", "symbol", "timestamp"),
    )
    ...
    def __repr__(self) -> str:
        return (
            f"FundingPayment(timestamp={self.timestamp}, config_file_path='{self.config_file_path}', "
