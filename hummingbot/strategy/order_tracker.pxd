...
cdef class OrderTracker(TimeIterator):
    cdef:
        ...
        dict _tracked_delayed_market_orders
        dict _order_id_to_market_pair
        dict _shadow_tracked_limit_orders
        dict _shadow_tracked_delayed_market_orders
    ...
    cdef c_start_tracking_delayed_market_order(self, object market_pair, str order_id, object order_type, bint is_buy, object reference_price,
