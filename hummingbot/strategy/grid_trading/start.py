...
from hummingbot.strategy.grid_trading import (
    GridTradingStrategy,
)
from hummingbot.strategy.grid_trading.grid_trading_config_map import grid_trading_config_map as c_map
...
def start(self):
    try:
        ...
        lower_bound = c_map.get("lower_bound").value
        upper_bound = c_map.get("upper_bound").value
        trading_direction = c_map.get("trading_direction").value
        max_amount = c_map.get("max_amount").value
        price_interval = c_map.get("price_interval").value
        size_of_order = c_map.get("size_of_order").value
        trigger_price = c_map.get("trigger_price").value
        ...
        strategy_logging_options = GridTradingStrategy.OPTION_LOG_ALL
