...
twap_config_map = {
    "strategy": ConfigVar(key="strategy", prompt=None, default="twap"),
    "connector": ConfigVar(
        key="connector",
    ...
    "start_datetime": ConfigVar(
        ...
        or twap_config_map.get("is_delayed_start_execution").value,
        prompt_on_new=True,
    ),
    "is_time_span_execution": ConfigVar(
        key="is_time_span_execution",
    ...
    "end_datetime": ConfigVar(
        key="end_datetime",
        prompt="Please enter the end date and time" " (YYYY-MM-DD HH:MM:SS) >>> ",
        type_str="str",
        validator=validate_datetime_iso_string,
    ...
    "order_delay_time": ConfigVar(
        key="order_delay_time",
