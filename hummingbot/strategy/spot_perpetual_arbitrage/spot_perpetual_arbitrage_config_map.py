...
spot_perpetual_arbitrage_config_map = {
    "strategy": ConfigVar(key="strategy", prompt="", default="spot_perpetual_arbitrage"),
    ...
    "order_amount": ConfigVar(key="order_amount", prompt=order_amount_prompt, type_str="decimal", prompt_on_new=True),
