...
discovery_config_map = {
    ...
    "target_symbol_1": ConfigVar(
        ...
        validator=lambda value: trading_pair_array_validator(discovery_config_map.get("primary_market").value, value),
        type_str="list",
        default=[],
    ),
    "target_symbol_2": ConfigVar(
        ...
        validator=lambda value: trading_pair_array_validator(discovery_config_map.get("secondary_market").value, value),
        type_str="list",
        default=[],
    ),
