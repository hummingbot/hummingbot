...
pure_market_making_config_map = {
    "strategy": ConfigVar(key="strategy", prompt=None, default="pure_market_making"),
    "exchange": ConfigVar(
        key="exchange",
    ...
    "market": ConfigVar(
        key="market", prompt=maker_trading_pair_prompt, validator=validate_exchange_trading_pair, prompt_on_new=True
    ),
    ...
    "price_floor": ConfigVar(
        key="price_floor",
        prompt="Enter the price below which only buy orders will be placed (Enter -1 to deactivate this feature) >>> ",
        type_str="decimal",
        default=Decimal("-1"),
        validator=validate_price_floor_ceiling,
    ),
    "moving_price_band_enabled": ConfigVar(
    ...
    "price_band_refresh_time": ConfigVar(
    ...
    "add_transaction_costs": ConfigVar(
        key="add_transaction_costs",
    ...
    "should_wait_order_cancel_confirmation": ConfigVar(
        key="should_wait_order_cancel_confirmation",
    ...
    "split_order_levels_enabled": ConfigVar(
        key="split_order_levels_enabled",
    ...
    "bid_order_level_spreads": ConfigVar(
        key="bid_order_level_spreads",
        ...
        default=None,
        type_str="str",
        required_if=lambda: pure_market_making_config_map.get("split_order_levels_enabled").value,
        validator=validate_decimal_list,
    ),
    "ask_order_level_spreads": ConfigVar(
        key="ask_order_level_spreads",
    ...
    "bid_order_level_amounts": ConfigVar(
        key="bid_order_level_amounts",
    ...
    "ask_order_level_amounts": ConfigVar(
        key="ask_order_level_amounts",
