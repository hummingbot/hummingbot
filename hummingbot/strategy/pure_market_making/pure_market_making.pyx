...
cdef class PureMarketMakingStrategy(StrategyBase):
    ...
    def argument_details(cls) -> Dict[str, Tuple[type, bool, Optional[Any]]]:
        return {
            ...
            "inventory_skew_enabled": (bool, False, False),
            "inventory_target_base_pct": (Decimal, False, s_decimal_zero),
            "inventory_range_multiplier": (Decimal, False, s_decimal_zero),
            ...
            "inventory_cost_price_delegate": (InventoryCostPriceDelegate, False, None),
