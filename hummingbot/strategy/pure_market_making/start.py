...
def start(self):
    try:
        ...
        base_bal_allocation_pct = c_map.get("base_bal_allocation_pct").value / Decimal('100')
        quote_bal_allocation_pct = c_map.get("quote_bal_allocation_pct").value / Decimal('100')
