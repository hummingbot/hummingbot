...
def start(self):
    ...
    slippage_buffer = amm_arb_config_map.get("slippage_buffer").value / Decimal("100")
    ...
    self.strategy = AmmArbStrategy(market_info_1, market_info_2, min_profitability, order_amount, slippage_buffer)
