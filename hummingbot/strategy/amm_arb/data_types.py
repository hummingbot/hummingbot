...
class ArbProposal:
    ...
    def profit_pct(self, account_for_fee: bool = False, first_side_quote_eth_rate: Decimal = None,
        ...
        if buy_quote_eth_rate and buy_trade_fee.flat_fees and buy_trade_fee.flat_fees[0][0].upper() == "ETH":
        ...
        if sell_quote_eth_rate and sell_trade_fee.flat_fees and sell_trade_fee.flat_fees[0][0].upper() == "ETH":
