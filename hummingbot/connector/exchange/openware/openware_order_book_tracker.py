...
class OpenwareOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self,
        ...
        super().__init__(OpenwareAPIOrderBookDataSource(throttler, trading_pairs), trading_pairs)
        ...
        self._order_books: Dict[str, OpenwareOrderBook] = {}
        self._saved_message_queues: Dict[str, Deque[OpenwareOrderBookMessage]] = \
            defaultdict(lambda: deque(maxlen=1000))
        self._active_order_trackers: Dict[str, OpenwareActiveOrderTracker] = defaultdict(OpenwareActiveOrderTracker)
    ...
    async def _track_single_book(self, trading_pair: str):
        ...
        """
        past_diffs_window: Deque[OpenwareOrderBookMessage] = deque()
        self._past_diffs_windows[trading_pair] = past_diffs_window

        message_queue: asyncio.Queue = self._tracking_message_queues[trading_pair]
        order_book: OpenwareOrderBook = self._order_books[trading_pair]
        active_order_tracker: OpenwareActiveOrderTracker = self._active_order_trackers[trading_pair]
        ...
        while True:
            try:
                message: OpenwareOrderBookMessage = None
                saved_messages: Deque[OpenwareOrderBookMessage] = self._saved_message_queues[trading_pair]
                ...
                if message.type is OrderBookMessageType.DIFF:
                    ...
                    past_diffs: List[OpenwareOrderBookMessage] = list(past_diffs_window)
