...
from .openware_utils import convert_from_exchange_trading_pair


class OpenwareOrderBookMessage(OrderBookMessage):
    def __new__(
        cls,
        ...
        **kwargs,
        ...
        return super(OpenwareOrderBookMessage, cls).__new__(
