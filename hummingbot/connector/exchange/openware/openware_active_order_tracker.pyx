...
OpenwareOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class OpenwareActiveOrderTracker:
    def __init__(self,
                 active_asks: OpenwareOrderBookTrackingDictionary = None,
                 active_bids: OpenwareOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> OpenwareOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> OpenwareOrderBookTrackingDictionary:
