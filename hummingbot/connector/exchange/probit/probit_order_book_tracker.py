...
class ProbitOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self, trading_pairs: Optional[List[str]] = None,):
        ...
        self._active_order_trackers: Dict[str, ProbitActiveOrderTracker] = defaultdict(ProbitActiveOrderTracker)
    ...
    async def _track_single_book(self, trading_pair: str):
        ...
        active_order_tracker: ProbitActiveOrderTracker = self._active_order_trackers[trading_pair]
