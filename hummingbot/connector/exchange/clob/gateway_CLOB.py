...
from hummingbot.connector.exchange.clob import clob_constants as CONSTANTS, clob_utils, clob_web_utils as web_utils
...
class GatewayCLOB(ExchangePyBase):
    ...
    async def _format_trading_rules(self, exchange_info_dict: Dict[str, Any]) -> List[TradingRule]:
        ...
        retval = []
        for rule in filter(clob_utils.is_exchange_information_valid, trading_pair_rules):
            try:
