...
BtcMarketsOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class BtcMarketsActiveOrderTracker:
    def __init__(self,
                 active_asks: BtcMarketsOrderBookTrackingDictionary = None,
                 active_bids: BtcMarketsOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> BtcMarketsOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> BtcMarketsOrderBookTrackingDictionary:
