...
from hummingbot.connector.exchange.coins_ph import coins_ph_constants as CONSTANTS, coins_ph_web_utils as web_utils
...
class CoinsPhAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    async def _subscribe_channels(self, websocket_assistant: WSAssistant):
        ...
        CoinsPh does not require any channel subscription.
    ...
    async def _get_listen_key(self):
        ...
        try:
            data = await rest_assistant.execute_request(
                url=web_utils.public_rest_url(path_url=CONSTANTS.COINS_PH_USER_STREAM_PATH_URL, domain=self._domain),
                method=RESTMethod.POST,
                throttler_limit_id=CONSTANTS.COINS_PH_USER_STREAM_PATH_URL,
