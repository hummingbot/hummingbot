...
HBOT_ORDER_ID_PREFIX = "cph-"
MAX_ORDER_ID_LEN = 32

# Base URL
REST_URL = "https://api.pro.coins.ph/openapi/"
WSS_PUBLIC_URL = "wss://wsapi.pro.coins.ph/openapi/quote/ws/v3/"
WSS_PRIVATE_URL = "wss://wsapi.pro.coins.ph/openapi/ws"

PUBLIC_API_VERSION = "v1"
PRIVATE_API_VERSION = "v1"

# Public API endpoints or CoinsPhClient function
...
# Private API endpoints or CoinsPhClient function
ACCOUNTS_PATH_URL = "/account"
MY_TRADES_PATH_URL = "/myTrades"
ORDER_PATH_URL = "/order"
COINS_PH_USER_STREAM_PATH_URL = "/userDataStream"
...
RATE_LIMITS = [
    ...
    RateLimit(limit_id=SNAPSHOT_PATH_URL, limit=MAX_REQUEST, time_interval=ONE_MINUTE,
              linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT, 50),
                             LinkedLimitWeightPair(RAW_REQUESTS, 1)]),
    RateLimit(limit_id=COINS_PH_USER_STREAM_PATH_URL, limit=MAX_REQUEST, time_interval=ONE_MINUTE,
              linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT, 1),
                             LinkedLimitWeightPair(RAW_REQUESTS, 1)]),
