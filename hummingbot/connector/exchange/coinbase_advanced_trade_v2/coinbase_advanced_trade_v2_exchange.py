...
from hummingbot.connector.exchange.coinbase_advanced_trade_v2 import (
    ...
    coinbase_advanced_trade_v2_utils,
...
class CoinbaseAdvancedTradeV2Exchange(ExchangePyBase):
    ...
    def __init__(self,
        ...
        self.api_key = coinbase_advanced_trade_v2_api_key
        self.secret_key = coinbase_advanced_trade_v2_api_secret
        self._domain = domain
        self._trading_required = trading_required
        self._trading_pairs = trading_pairs
        self._last_trades_poll_coinbase_advanced_trade_v2_timestamp = 1.0
    ...
    async def _format_trading_rules(self, exchange_info_dict: Dict[str, Any]) -> List[TradingRule]:
        ...
        retval = []
        for rule in filter(coinbase_advanced_trade_v2_utils.is_exchange_information_valid, trading_pair_rules):
            try:
    ...
    async def _update_order_fills_from_trades(self):
        ...
        in case Coinbase Advanced Trade V2's user stream events are not working.
        NOTE: It is not required to copy this functionality in other connectors.
        This is separated from _update_order_status which only updates the order status without producing filled
        events, since Coinbase Advanced Trade V2's get order endpoint does not return trade IDs.
        ...
        if (long_interval_current_tick > long_interval_last_tick
            ...
            query_time = int(self._last_trades_poll_coinbase_advanced_trade_v2_timestamp * 1e3)
            self._last_trades_poll_coinbase_advanced_trade_v2_timestamp = self._time_synchronizer.time()
    ...
    def _initialize_trading_pair_symbols_from_exchange_info(self, exchange_info: Dict[str, Any]):
        mapping = bidict()
        for symbol_data in filter(coinbase_advanced_trade_v2_utils.is_exchange_information_valid, exchange_info["symbols"]):
