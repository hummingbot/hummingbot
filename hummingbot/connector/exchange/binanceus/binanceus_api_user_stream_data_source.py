...
from hummingbot.connector.exchange.binanceus import binanceus_constants as CONSTANTS, binanceus_web_utils as web_utils
...
if TYPE_CHECKING:
    from hummingbot.connector.exchange.binanceus.binanceus_exchange import binanceusExchange


class binanceusAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self,
                 ...
                 connector: 'binanceusExchange',
                 api_factory: WebAssistantsFactory,
                 domain: str = CONSTANTS.DEFAULT_DOMAIN):
        super().__init__()
        self._auth: binanceusAuth = auth
    ...
    async def _subscribe_channels(self, websocket_assistant: WSAssistant):
        ...
        binanceus does not require any channel subscription.
    ...
    async def _get_listen_key(self):
        ...
        try:
            data = await rest_assistant.execute_request(
                url=web_utils.public_rest_url(path_url=CONSTANTS.binanceus_USER_STREAM_PATH_URL, domain=self._domain),
                method=RESTMethod.POST,
                throttler_limit_id=CONSTANTS.binanceus_USER_STREAM_PATH_URL,
