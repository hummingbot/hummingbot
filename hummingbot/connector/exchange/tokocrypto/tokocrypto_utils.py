...
TRADING_PAIR_SPLITTER = re.compile(r"^(\w+)(BNB|LINK|LINKDOWN|LEND|LINKUP|KNC|LTC|JST|LTCDOWN|ETHUP|LTCUP|ETHDOWN|OGN|ONE|EOSUP|SAND|EOSDOWN|SNX|SRM|EGLD|SXP|DOTUP|TRX|DOTDOWN|TRXDOWN|TRXUP|DOGE|UNI|DASH|USDC|CTSI|USDT|CREAM|WAVES|COMP|WRX|BUSD|XLM|BTCUP|XRP|BTCDOWN|XRPDOWN|XRPUP|BNBUP|XTZ|BNBDOWN|XTZDOWN|BKRW|XTZUP|BCH|YFI|BAND|YFII|ADAUP|ZIL|ADADOWN|BIDR)$")
