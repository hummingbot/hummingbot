...
from .exceptions import TokocryptoAPIException, TokocryptoRequestException, TokocryptoWithdrawException
...
class Client(object):
    ...
    def __init__(self, api_key=None, api_secret=None, requests_params=None, tld='com'):
        """Tokocrypto API Client constructor
    ...
    def _handle_response(self):
        """Internal helper for handling API responses from the Tokocrypto server.
    ...
    def aggregate_trade_iter(self, symbol, start_str=None, last_id=None):
        ...
        while True:
            ...
            # only thread running calls like this, Tokocrypto will automatically
            # add the right delay time on their end, forcing us to wait for
            # data. That really simplifies this function's job. Tokocrypto is
            # fucking awesome.
    ...
    def _get_earliest_valid_timestamp(self, symbol, interval):
        """Get earliest valid open timestamp from Tokocrypto

        :param symbol: Name of symbol pair e.g BNBBTC
        :type symbol: str
        :param interval: Tokocrypto Kline interval
        :type interval: str
...
"""
    ...
    def create_order(self, **params):
        ...
        :raises: TokocryptoRequestException, TokocryptoAPIException, TokocryptoOrderException, TokocryptoOrderMinAmountException, TokocryptoOrderMinPriceException, TokocryptoOrderMinTotalException, TokocryptoOrderUnknownSymbolException, TokocryptoOrderInactiveSymbolException
    ...
    def get_account_status(self, **params):
        ...
        :raises: TokocryptoWithdrawException

        """
        res = self._request_withdraw_api('get', 'accountStatus.html', True, data=params)
        if not res['success']:
            raise TokocryptoWithdrawException(res['msg'])
        return res
    ...
    def withdraw(self, **params):
        ...
        :raises: TokocryptoRequestException, TokocryptoAPIException, TokocryptoWithdrawException
    ...
    def create_margin_order(self, **params):
        ...
        :raises: TokocryptoRequestException, TokocryptoAPIException, TokocryptoOrderException, TokocryptoOrderMinAmountException,
            TokocryptoOrderMinPriceException, TokocryptoOrderMinTotalException, TokocryptoOrderUnknownSymbolException,
            TokocryptoOrderInactiveSymbolException
