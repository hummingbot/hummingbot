...
def public_rest_url(path_url: str, domain: str = CONSTANTS.DEFAULT_DOMAIN) -> str:
    ...
    :param domain: the Crypto.com domain to connect to ("com" or "us"). The default value is "com"
...
async def get_current_server_time(
    ...
    # since Crypto.com does not provide a server time endpoint, we use the time.time() as a fallback
