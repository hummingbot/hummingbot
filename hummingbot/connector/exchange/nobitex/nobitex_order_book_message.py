...
class NobitexOrderBookMessage(OrderBookMessage):
    def __new__(
        cls,
        ...
        **kwargs,
        ...
        return super(NobitexOrderBookMessage, cls).__new__(
    ...
    def asks(self) -> List[OrderBookRow]:
        # raise NotImplementedError("nobitex order book messages have different semantics.")
        return [
