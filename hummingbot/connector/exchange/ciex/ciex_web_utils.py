...
import hummingbot.connector.exchange.ciex.ciex_constants as CONSTANTS
...
async def get_current_server_time(
    ...
    response = await rest_assistant.execute_request(
        url=public_rest_url(path_url=CONSTANTS.CIEX_TIME_PATH),
        throttler_limit_id=CONSTANTS.CIEX_TIME_PATH,
