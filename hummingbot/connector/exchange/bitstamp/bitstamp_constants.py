...
RATE_LIMITS = [
    ...
    RateLimit(
        limit_id=REQUEST_WEIGHT_LIMIT_ID,
        limit=MAX_REQUESTS_PER_SECOND,
        time_interval=SECOND,
        linked_limits=[LinkedLimitWeightPair(RAW_REQUESTS_LIMIT_ID)],
    ),
    RateLimit(
        limit_id=STATUS_URL,
        limit=MAX_REQUESTS_PER_SECOND,
        time_interval=SECOND,
        linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT_LIMIT_ID), LinkedLimitWeightPair(RAW_REQUESTS_LIMIT_ID)],
    ),
    RateLimit(
        limit_id=CURRENCIES_URL,
        limit=MAX_REQUESTS_PER_SECOND,
        time_interval=SECOND,
        linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT_LIMIT_ID), LinkedLimitWeightPair(RAW_REQUESTS_LIMIT_ID)],
    ),
    ...
    RateLimit(
        limit_id=ORDER_BOOK_URL_LIMIT_ID,
        limit=MAX_REQUESTS_PER_SECOND,
        time_interval=SECOND,
        linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT_LIMIT_ID), LinkedLimitWeightPair(RAW_REQUESTS_LIMIT_ID)],
    ),
    RateLimit(
        limit_id=TICKER_URL_LIMIT_ID,
        limit=MAX_REQUESTS_PER_SECOND,
        time_interval=SECOND,
        linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT_LIMIT_ID), LinkedLimitWeightPair(RAW_REQUESTS_LIMIT_ID)],
    ),
    RateLimit(
        limit_id=ACCOUNT_BALANCES_URL,
        limit=MAX_REQUESTS_PER_SECOND,
        time_interval=SECOND,
        linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT_LIMIT_ID), LinkedLimitWeightPair(RAW_REQUESTS_LIMIT_ID)],
    ),
    RateLimit(
        limit_id=ORDER_CREATE_URL_LIMIT_ID,
        limit=MAX_REQUESTS_PER_SECOND,
        time_interval=SECOND,
        linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT_LIMIT_ID), LinkedLimitWeightPair(RAW_REQUESTS_LIMIT_ID)],
    ),
    RateLimit(
        limit_id=ORDER_CANCEL_URL,
        limit=MAX_REQUESTS_PER_SECOND,
        time_interval=SECOND,
        linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT_LIMIT_ID), LinkedLimitWeightPair(RAW_REQUESTS_LIMIT_ID)],
    ),
    RateLimit(
        limit_id=ORDER_STATUS_URL,
        limit=MAX_REQUESTS_PER_SECOND,
        time_interval=SECOND,
        linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT_LIMIT_ID), LinkedLimitWeightPair(RAW_REQUESTS_LIMIT_ID)],
    ),
    RateLimit(
        limit_id=TRADING_FEES_URL,
        limit=MAX_REQUESTS_PER_SECOND,
        time_interval=SECOND,
        linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT_LIMIT_ID), LinkedLimitWeightPair(RAW_REQUESTS_LIMIT_ID)],
    ),
    RateLimit(
        limit_id=WEBSOCKET_TOKEN_URL,
        limit=MAX_REQUESTS_PER_SECOND,
        time_interval=SECOND,
        linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT_LIMIT_ID), LinkedLimitWeightPair(RAW_REQUESTS_LIMIT_ID)],
    ),
