...
class ExtendedAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(
        ...
        super().__init__()
        self._extended_auth: ExtendedAuth = auth
    ...
    async def _connected_websocket_assistant(self) -> WSAssistant:
        ...
        headers = self._extended_auth.get_auth_headers(CONSTANTS.ACCOUNT_UPDATES_CHANNEL)
        
        ws: WSAssistant = await self._api_factory.get_ws_assistant()
        await ws.connect(ws_url=CONSTANTS.PRIVATE_WS_URL, ws_headers=headers)
        return ws
    ...
    async def _subscribe_channels(self, websocket_assistant: WSAssistant):
        ...
        try:
            ...
            payload = {
                "type": "subscribe",
                "channel": CONSTANTS.ACCOUNT_UPDATES_CHANNEL
            }
    ...
    async def _process_event_message(
        ...
        if len(event_message) > 0:
            ...
            elif channel == CONSTANTS.ACCOUNT_UPDATES_CHANNEL:
