...
class InjectiveGranteeDataSource(InjectiveDataSource):
    ...
    def __init__(
        ...
        self._query_executor = PythonSDKInjectiveQueryExecutor(
            sdk_client=self._client, indexer_client=self._indexer_client
        )
    ...
    async def _order_creation_messages(
        ...
        delegated_message = composer.msg_exec(grantee=self.trading_account_injective_address, msgs=all_messages)
    ...
    async def _order_cancel_message(
        ...
        delegated_message = composer.msg_exec(grantee=self.trading_account_injective_address, msgs=[message])
        return delegated_message
