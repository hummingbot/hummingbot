...
# Base URL
REST_URLS = {"hashkey_global": "https://api-glb.hashkey.com", "hashkey_global_testnet": "https://api.sim.bmuxdc.com"}

WSS_PUBLIC_URL = {
    "hashkey_global": "wss://stream-glb.hashkey.com/quote/ws/v1",
    "hashkey_global_testnet": "wss://stream.sim.bmuxdc.com/quote/ws/v1",
}

WSS_PRIVATE_URL = {
    "hashkey_global": "wss://stream-glb.hashkey.com/api/v1/ws/{listenKey}",
...
RATE_LIMITS = {
    ...
    RateLimit(
        limit_id=USER_STREAM_PATH_URL,
        limit=MAX_REQUEST_PUT,
        time_interval=TWO_MINUTES,
        linked_limits=[
            LinkedLimitWeightPair(REQUEST_PUT, 1),
            LinkedLimitWeightPair(REQUEST_PUT_BURST, 1),
