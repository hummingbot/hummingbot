...
class BackpackExchange(ExchangePyBase):
    """
    BackpackExchange connects with BitMart exchange and provides order book pricing, user account tracking and
    ...
    def __init__(self,
        ...
        """
        :param backpack_api_key: The API key to connect to private BitMart APIs.
        :param backpack_secret_key: The API secret.
        :param trading_pairs: The market trading pairs which to track order book data.
        :param trading_required: Whether actual trading is needed.
        """
        self._api_key: str = backpack_api_key
        self._secret_key: str = backpack_secret_key
        self._memo: str = backpack_memo
    ...
    async def _format_trading_rules(self, symbols_details: Dict[str, Any]) -> List[TradingRule]:
        ...
        for rule in symbols_details["data"]["symbols"]:
            if backpack_utils.is_exchange_information_valid(rule):
                try:
    ...
    def _create_order_update(self, order: InFlightOrder, order_update: Dict[str, Any]) -> OrderUpdate:
        ...
        # Backpack reports this state for a successfully filled MARKET BUY order which is confusing.
    ...
    async def _user_stream_event_listener(self):
        async for event_message in self._iter_user_event_queue():
            try:
                ...
                # Refer to https://developer-pro.backpack.com/en/spot/#private-order-progress
    ...
    def _initialize_trading_pair_symbols_from_exchange_info(self, exchange_info: Dict[str, Any]):
        mapping = bidict()
        for symbol_data in filter(backpack_utils.is_exchange_information_valid, exchange_info["data"]["symbols"]):
