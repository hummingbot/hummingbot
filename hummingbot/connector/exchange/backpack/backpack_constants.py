...
TESTNET_DOMAIN = "backpack_testnet"
...
BALANCE_URL = "/api/v1/capital"  # Alias for balance endpoint
...
# Rate Limits - Backpack doesn't document specific limits, using conservative defaults
