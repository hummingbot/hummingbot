...
class BackpackAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    def __init__(self,
        ...
        self._connector: BackpackExchange = connector
    ...
    async def listen_for_order_book_diffs(self, ev_loop: asyncio.AbstractEventLoop, output: asyncio.Queue):
        """
        Backpack only sends full snapshots, they never send diff messages. That is why this method is overwritten to
        do nothing.
    ...
    async def listen_for_order_book_snapshots(self, ev_loop: asyncio.AbstractEventLoop, output: asyncio.Queue):
        """
        Backpack sends always full snapshots through the depth channel. That is why they are processed here.
    ...
    async def _parse_order_book_diff_message(self, raw_message: Dict[str, Any], message_queue: asyncio.Queue):
        # Backpack never sends diff messages. This method will never be called
        pass
