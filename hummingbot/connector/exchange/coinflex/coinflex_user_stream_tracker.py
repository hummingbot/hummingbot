...
class CoinflexUserStreamTracker(UserStreamTracker):
    ...
    def __init__(self, auth: CoinflexAuth, domain: str = "live", throttler: Optional[AsyncThrottler] = None):
        super().__init__()
    ...
    def data_source(self) -> UserStreamTrackerDataSource:
        ...
        if not self._data_source:
            self._data_source = CoinflexAPIUserStreamDataSource(auth=self._auth, domain=self._domain, throttler=self._throttler)
