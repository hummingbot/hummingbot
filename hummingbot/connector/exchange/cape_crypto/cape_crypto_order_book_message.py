...
@total_ordering
class CapeCryptoOrderBookBookMessage(namedtuple("_OrderBookMessage", "type, content, timestamp")):
    ...
    def __new__(
        ...
        **kwargs,
        ...
        return super(CapeCryptoOrderBookBookMessage, cls).__new__(cls, message_type, content, timestamp, *args, **kwargs)
