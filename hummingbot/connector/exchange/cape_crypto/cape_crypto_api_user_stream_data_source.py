...
class CapeCryptoAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self,
        ...
        super().__init__()
        self._auth: CapeCryptoAuth = auth
    ...
    async def _subscribe_channels(self, websocket_assistant: WSAssistant):
        ...
        CapeCrypto Account WSS is subscirbed in the url during connection.
