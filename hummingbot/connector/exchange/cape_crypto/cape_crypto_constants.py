...
# Base URL
REST_URL = "https://trade.capecrypto.com/api/v2/peatio"

# WEBSOCKET ENDPOINTS
WSS_PRIVATE_URL = "wss://trade.capecrypto.com/api/v2/ranger/private?stream=order&stream=trade&stream=balance"
WSS_PUBLIC_URL = "wss://trade.capecrypto.com/api/v2/ranger/public{}"
