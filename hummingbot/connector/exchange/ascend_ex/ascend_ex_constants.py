...
RATE_LIMITS = [
    ...
    RateLimit(limit_id=TRADES_PATH_URL, limit=100, time_interval=1, linked_limits=[ALL_ENDPOINTS_LIMIT]),
    RateLimit(limit_id=DEPTH_PATH_URL, limit=100, time_interval=1, linked_limits=[ALL_ENDPOINTS_LIMIT]),
    RateLimit(limit_id=INFO_PATH_URL, limit=100, time_interval=1, linked_limits=[ALL_ENDPOINTS_LIMIT]),
    RateLimit(limit_id=SUB_ENDPOINT_NAME, limit=100, time_interval=1, linked_limits=[ALL_ENDPOINTS_LIMIT]),
    RateLimit(limit_id=PONG_ENDPOINT_NAME, limit=100, time_interval=1, linked_limits=[ALL_ENDPOINTS_LIMIT]),
]
