...
from hummingbot.connector.exchange.aevo import aevo_constants as CONSTANTS, aevo_web_utils as web_utils
...
if TYPE_CHECKING:
    from hummingbot.connector.exchange.aevo.aevo_exchange import AevoExchange


class AevoAPIUserStreamDataSource(UserStreamTrackerDataSource):
    """
    Data source for retrieving user stream data from the Aevo exchange via WebSocket APIs.
    """
