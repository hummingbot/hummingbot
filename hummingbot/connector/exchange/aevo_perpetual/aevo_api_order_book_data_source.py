...
class AevoAPIOrderBookDataSource(OrderBookTrackerDataSource):
    """
    Data source for retrieving order book data from the Aevo exchange via REST and WebSocket APIs.
    """
    ...
    def __init__(
        ...
        self._connector: 'AevoExchange' = connector
