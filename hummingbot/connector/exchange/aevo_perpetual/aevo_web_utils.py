...
from hummingbot.connector.exchange.aevo import aevo_constants as CONSTANTS
...
def public_rest_url(path_url: str, domain: str = CONSTANTS.DEFAULT_DOMAIN) -> str:
    ...
    :param domain: the Aevo domain to connect to ("com" or "us"). The default value is "com"
