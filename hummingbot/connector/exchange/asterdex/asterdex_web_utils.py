...
class AsterdexRESTPreProcessor(RESTPreProcessorBase):
...
def build_api_factory(
    ...
    api_factory = WebAssistantsFactory(throttler=throttler, auth=auth, rest_pre_processors=[AsterdexRESTPreProcessor()])
    return api_factory
