...
RATE_LIMITS = [
    ...
    RateLimit(limit_id=ACCOUNTS_PATH_URL, limit=20, time_interval=1),
    RateLimit(limit_id=CREATE_LIMIT_ORDER_PATH_URL, limit=20, time_interval=1),
    RateLimit(limit_id=CREATE_MARKET_BUY_ORDER_PATH_URL, limit=20, time_interval=1),
    RateLimit(limit_id=CREATE_MARKET_SELL_ORDER_PATH_URL, limit=20, time_interval=1),
