...
class FmfwOrderBookMessage(OrderBookMessage):
    def __new__(
        cls,
        ...
        **kwargs,
        ...
        return super(FmfwOrderBookMessage, cls).__new__(
    ...
    def asks(self) -> List[OrderBookRow]:
        # raise NotImplementedError("Fmfw order book messages have different semantics.")
        return [
