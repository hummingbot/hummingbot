...
FmfwOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class FmfwActiveOrderTracker:
    def __init__(self,
                 active_asks: FmfwOrderBookTrackingDictionary = None,
                 active_bids: FmfwOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> FmfwOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> FmfwOrderBookTrackingDictionary:
