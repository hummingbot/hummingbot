...
async def fetch_lighter_public_key(connector_name: str, account_index: str, api_key_index: str) -> Optional[str]:
    from hummingbot.connector.lighter_common.lighter_key_utils import fetch_lighter_public_key as _fetch

    return await _fetch(connector_name, account_index, api_key_index)


async def validate_lighter_api_key_index(connector_name: str, account_index: str, api_key_index: str) -> Optional[str]:
    from hummingbot.connector.lighter_common.lighter_key_utils import validate_lighter_api_key_index as _validate

    return await _validate(connector_name, account_index, api_key_index)
