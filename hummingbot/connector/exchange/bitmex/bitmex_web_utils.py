...
class BitmexRESTPreProcessor(RESTPreProcessorBase):
...
def rest_url(path_url: str, domain: str = "bitmex"):
    base_url = CONSTANTS.BASE_URL if domain == "bitmex" else CONSTANTS.TESTNET_BASE_URL
    return base_url + path_url


def wss_url(endpoint: str, domain: str = "bitmex"):
    base_ws_url = CONSTANTS.WS_URL if domain == "bitmex" else CONSTANTS.TESTNET_WS_URL
