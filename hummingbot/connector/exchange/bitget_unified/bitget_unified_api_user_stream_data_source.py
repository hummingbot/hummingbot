...
from hummingbot.connector.exchange.bitget_unified import (
    bitget_unified_constants as CONSTANTS,
    bitget_unified_web_utils as web_utils,
)
...
class BitgetUnifiedAPIUserStreamDataSource(UserStreamTrackerDataSource):
    """
    Data source for retrieving user stream data from the BitgetUnified exchange via WebSocket APIs.
    """
    ...
    def __init__(
        self,
        auth: BitgetUnifiedAuth,
        trading_pairs: List[str],
        connector: 'BitgetUnifiedExchange',
