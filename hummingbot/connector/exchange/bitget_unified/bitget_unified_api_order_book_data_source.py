...
class BitgetUnifiedAPIOrderBookDataSource(OrderBookTrackerDataSource):
    """
    Data source for retrieving order book data from the BitgetUnified exchange via REST and WebSocket APIs.
    """
    ...
    def __init__(
        ...
        self._connector: 'BitgetUnifiedExchange' = connector
