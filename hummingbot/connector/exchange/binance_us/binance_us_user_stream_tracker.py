...
from .binance_us_api_user_stream_data_source import BinanceUsAPIUserStreamDataSource
...
class BinanceUsUserStreamTracker(UserStreamTracker):
    ...
    def data_source(self) -> UserStreamTrackerDataSource:
        if not self._data_source:
            self._data_source = BinanceUsAPIUserStreamDataSource(binance_client=self._binance_client)
