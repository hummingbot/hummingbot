...
from . import binance_us_utils

_bob_logger = None


cdef class BinanceUsOrderBook(OrderBook):
    @classmethod
    ...
    def diff_message_from_exchange(cls,
        ...
        return OrderBookMessage(OrderBookMessageType.DIFF, {
            "trading_pair": binance_us_utils.convert_from_exchange_trading_pair(msg["s"]),
            "update_id": msg["u"],
            "bids": msg["b"],
            "asks": msg["a"]
        }, timestamp=timestamp)
