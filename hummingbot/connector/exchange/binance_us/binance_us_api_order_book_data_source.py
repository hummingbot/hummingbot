...
from hummingbot.connector.exchange.binance_us.binance_us_order_book import BinanceUsOrderBook
...
SNAPSHOT_REST_URL = "https://api.binance.us/api/v1/depth"
DIFF_STREAM_URL = "wss://stream.binance.us:9443/ws"
TICKER_PRICE_CHANGE_URL = "https://api.binance.us/api/v1/ticker/24hr"
EXCHANGE_INFO_URL = "https://api.binance.us/api/v1/exchangeInfo"


class BinanceUsAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def fetch_trading_pairs() -> List[str]:
        try:
            ...
            # Do nothing if the request fails -- there will be no autocomplete for binance.us trading pairs
            pass
    ...
    async def get_snapshot(client: aiohttp.ClientSession, trading_pair: str, limit: int = 1000) -> Dict[str, Any]:
        ...
        async with client.get(SNAPSHOT_REST_URL, params=params) as response:
            ...
            if response.status != 200:
                raise IOError(f"Error fetching Binance.US market snapshot for {trading_pair}. "
    ...
    async def get_new_order_book(self, trading_pair: str) -> OrderBook:
        async with aiohttp.ClientSession() as client:
            ...
            snapshot_msg: OrderBookMessage = BinanceUsOrderBook.snapshot_message_from_exchange(
                snapshot,
                snapshot_timestamp,
            ...
            try:
                ...
                async with websockets.connect(stream_url) as ws:
                    ...
                    async for raw_msg in self._inner_messages(ws):
                        ...
                        trade_msg: OrderBookMessage = BinanceUsOrderBook.trade_message_from_exchange(msg)
        ...
        while True:
            try:
                ...
                async with websockets.connect(stream_url) as ws:
                    ...
                    async for raw_msg in self._inner_messages(ws):
                        msg = ujson.loads(raw_msg)
                        order_book_message: OrderBookMessage = BinanceUsOrderBook.diff_message_from_exchange(
                            msg, time.time())
                ...
                async with aiohttp.ClientSession() as client:
                    for trading_pair in self._trading_pairs:
                        try:
                            ...
                            # Be careful not to go above Binance.US API rate limits.
