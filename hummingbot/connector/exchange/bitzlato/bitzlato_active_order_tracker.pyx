...
BitzlatoOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]


cdef class BitzlatoActiveOrderTracker:
    def __init__(self,
                 active_asks: BitzlatoOrderBookTrackingDictionary = None,
                 active_bids: BitzlatoOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> BitzlatoOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> BitzlatoOrderBookTrackingDictionary:
