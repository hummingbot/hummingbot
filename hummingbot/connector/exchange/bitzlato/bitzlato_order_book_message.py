...
from .bitzlato_utils import convert_from_exchange_trading_pair


class BitzlatoOrderBookMessage(OrderBookMessage):
    def __new__(
        cls,
        ...
        **kwargs,
        ...
        return super(BitzlatoOrderBookMessage, cls).__new__(
