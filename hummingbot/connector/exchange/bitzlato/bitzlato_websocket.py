...
from hummingbot.connector.exchange.bitzlato.bitzlato_utils import RequestId
...
class BitzlatoWebsocket(RequestId):
    ...
    def __init__(self,
                 auth: Optional[BitzlatoAuth] = None,
                 throttler: Optional[AsyncThrottler] = None):
        self._auth: Optional[BitzlatoAuth] = auth
