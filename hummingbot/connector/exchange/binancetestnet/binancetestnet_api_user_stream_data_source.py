...
class BinancetestnetAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self,
                 auth: BinancetestnetAuth,
                 trading_pairs: List[str],
                 connector: 'BinancetestnetExchange',
                 api_factory: WebAssistantsFactory,
                 domain: str = CONSTANTS.DEFAULT_DOMAIN):
        super().__init__()
        self._auth: BinancetestnetAuth = auth
    ...
    async def _subscribe_channels(self, websocket_assistant: WSAssistant):
        ...
        Binancetestnet does not require any channel subscription.
