...
OKEX_ORDER_DETAILS_URL = 'api/v5/trade/order?ordId={exchange_order_id}'
OKEX_ORDER_CANCEL = 'api/v5/trade/cancel-order?ordId={exchange_order_id}'
...
OKEX_WS_CHANNEL_SPOT_ACCOUNT = "account"
OKEX_WS_CHANNEL_SPOT_ORDER = "orders"
