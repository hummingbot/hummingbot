...
cdef class CoinexInFlightOrder(InFlightOrderBase):
    def __init__(self,
                 client_order_id: str,
    ...
    def is_done(self) -> bool:
        # TODO: Review for correct CoinEx states
    ...
    def from_json(cls, data: Dict[str, Any]) -> InFlightOrderBase:
        ...
        # TODO: Review as above
        cdef:
            CoinexInFlightOrder retval = CoinexInFlightOrder(
