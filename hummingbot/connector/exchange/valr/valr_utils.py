...
class ValrConfigMap(BaseConnectorConfigMap):
    connector: str = Field(default="valr", client_data=None)
    valr_api_key: SecretStr = Field(
        default=...,
        client_data=ClientFieldData(
            prompt=lambda cm: "Enter your Valr.com API key",
            is_secure=True,
            is_connect_key=True,
            prompt_on_new=True,
        )
    ...
    valr_api_secret: SecretStr = Field(
        default=...,
        client_data=ClientFieldData(
            prompt=lambda cm: "Enter your Valr.com secret key",
            is_secure=True,
            is_connect_key=True,
            prompt_on_new=True,
        )
...
def is_exchange_information_valid(exchange_info: Dict[str, Any]) -> bool:
    ...
    """
    return exchange_info.get("active", None) == True
