...
class TegroOrderBook(OrderBook):
    ...
    def snapshot_message_from_exchange(
        ...
        return OrderBookMessage(
            ...
            {"trading_pair": msg["trading_pair"], "update_id": msg["timestamp"], "bids": bids, "asks": asks},
            timestamp=timestamp,
        )
    ...
    def diff_message_from_exchange(
        ...
        return OrderBookMessage(
            ...
            {"trading_pair": msg["trading_pair"], "update_id": msg["data"]["timestamp"], "bids": bids, "asks": asks},
    ...
    def trade_message_from_exchange(
        ...
        return OrderBookMessage(
            OrderBookMessageType.TRADE,
            {
                ...
                "trade_type": (
                    float(TradeType.BUY.value) if msg["data"]["is_buyer_maker"] else float(TradeType.SELL.value)
                ),
