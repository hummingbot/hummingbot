...
from hummingbot.connector.exchange.xeggex.xeggex_in_flight_order import XeggexInFlightOrder
from hummingbot.connector.exchange.xeggex.xeggex_order_book_tracker import XeggexOrderBookTracker
from hummingbot.connector.exchange.xeggex.xeggex_user_stream_tracker import XeggexUserStreamTracker
from hummingbot.connector.exchange.xeggex.xeggex_utils import (
    XeggexAPIError,
...
class XeggexExchange(ExchangeBase):
    """
    ...
    def __init__(self,
        ...
        self._xeggex_auth = XeggexAuth(xeggex_api_key, xeggex_secret_key, time_provider=self._time_synchronizer)
        self._set_order_book_tracker(XeggexOrderBookTracker(trading_pairs=trading_pairs))
        self._user_stream_tracker = XeggexUserStreamTracker(self._xeggex_auth, trading_pairs)
        self._ev_loop = asyncio.get_event_loop()
        self._shared_client = None
        self._poll_notifier = asyncio.Event()
        self._last_timestamp = 0
        self._in_flight_orders = {}  # Dict[client_order_id:str, XeggexInFlightOrder]
    ...
    @property
    def in_flight_orders(self) -> Dict[str, XeggexInFlightOrder]:
    ...
    async def _api_request(self,
        ...
        if "error" in parsed_response:
            raise XeggexAPIError(parsed_response)
    ...
    def start_tracking_order(self,
        ...
        """
        self._in_flight_orders[order_id] = XeggexInFlightOrder(
    ...
    async def _execute_cancel(self, trading_pair: str, order_id: str) -> str:
        ...
        :param trading_pair: The market trading pair (Unused during cancel on Xeggex)
    ...
    async def all_trading_pairs(self) -> List[str]:
        ...
        return await XeggexAPIOrderBookDataSource.fetch_trading_pairs()

    async def get_last_traded_prices(self, trading_pairs: List[str]) -> Dict[str, float]:
        # This method should be removed and instead we should implement _get_last_traded_price
        return await XeggexAPIOrderBookDataSource.get_last_traded_prices(trading_pairs=trading_pairs)
