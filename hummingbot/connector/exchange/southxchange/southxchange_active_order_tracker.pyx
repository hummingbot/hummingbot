...
SouthXchangeOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class SouthXchangeActiveOrderTracker:
    def __init__(self,
                 active_asks: SouthXchangeOrderBookTrackingDictionary = None,
                 active_bids: SouthXchangeOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> SouthXchangeOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> SouthXchangeOrderBookTrackingDictionary:
    ...
    cdef tuple c_convert_snapshot_message_to_np_arrays(self, object message):
        ...
        for snapshot_orders, active_orders in [(content["BuyOrders"], self._active_bids), (content["SellOrders"], self.active_asks)]:
