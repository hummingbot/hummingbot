...
class SouthxchangeExchange(ExchangePyBase):
    ...
    def __init__(self,
        ...
        # self._user_stream_tracker = AscendExUserStreamTracker(self._southxchange_auth, trading_pairs)
    ...
    ) -> Dict[str, SouthXchangeTradingRule]:
        """
    ...
    #             "orders": [
    #                 {
    #                     'id': southxchange_utils.uuid32(),
    #                     "orderId": order.exchange_order_id,
    #                     "symbol": southxchange_utils.convert_to_exchange_trading_pair(order.trading_pair),
