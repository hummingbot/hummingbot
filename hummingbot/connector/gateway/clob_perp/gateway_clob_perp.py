...
class GatewayCLOBPerpetual(PerpetualDerivativePyBase):
    ...
    def get_buy_collateral_token(self, trading_pair: str) -> str:
        return self._api_data_source.get_buy_collateral_token(trading_pair)

    def get_sell_collateral_token(self, trading_pair: str) -> str:
        return self._api_data_source.get_sell_collateral_token(trading_pair)
    ...
    async def _update_positions(self):
        return await self._api_data_source.update_positions()
