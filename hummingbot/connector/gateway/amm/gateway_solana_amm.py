...
class GatewaySolanaAMM(ConnectorBase):
    """
    Defines basic functions for interacting with Solana AMM protocols via Gateway.
    """
    ...
    async def get_gas_estimate(self):
        ...
        try:
            ...
            self._network_transaction_fee = TokenAmount(
    ...
    def process_trade_fill_update(self, tracked_order: GatewayInFlightOrder, fee: Decimal):
        """
        Processes trade fill update from the gateway.
        """
    ...
    def status_dict(self) -> Dict[str, bool]:
        """
        Returns a dictionary of relevant status checks.
        """
        return {
            "account_balance": len(self._account_balances) > 0 if self._trading_required else True,
            "native_currency": self._native_currency is not None,
            "network_transaction_fee": self._network_transaction_fee is not None if self._trading_required else True,
        }
