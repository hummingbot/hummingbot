...
from hummingbot.connector.gateway.clob.backup import clob_constants as constant
from hummingbot.connector.gateway.clob.backup.clob_order_book import CLOBOrderBook
