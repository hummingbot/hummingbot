...
class CoinflexPerpetualOrderBookTracker(OrderBookTracker):
    _cfpobt_logger: Optional[HummingbotLogger] = None

    @classmethod
    def logger(cls) -> HummingbotLogger:
        if cls._cfpobt_logger is None:
            cls._cfpobt_logger = logging.getLogger(__name__)
        return cls._cfpobt_logger
    ...
    def __init__(self,
        ...
        super().__init__(data_source=CoinflexPerpetualAPIOrderBookDataSource(trading_pairs=trading_pairs,
                                                                             domain=domain,
                                                                             throttler=throttler,
