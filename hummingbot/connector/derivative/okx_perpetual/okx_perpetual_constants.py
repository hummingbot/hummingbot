...
REST_URLS = {
    DEFAULT_DOMAIN: "https://www.okx.com",
...
# -------------------------------------------
WSS_PUBLIC_URLS = {
    DEFAULT_DOMAIN: f"wss://ws.okx.com:8443/ws/{REST_API_VERSION}/public",
...
WSS_PRIVATE_URLS = {
    DEFAULT_DOMAIN: f"wss://ws.okx.com:8443/ws/{REST_API_VERSION}/private",
...
WSS_BUSINESS_URLS = {
    DEFAULT_DOMAIN: f"wss://ws.okx.com:8443/ws/{REST_API_VERSION}/business",
...
REST_LATEST_SYMBOL_INFORMATION = {METHOD: GET, ENDPOINT: f"/api/{REST_API_VERSION}/market/tickers"}
REST_ORDER_BOOK = {METHOD: GET, ENDPOINT: f"/api/{REST_API_VERSION}/market/books"}
REST_SERVER_TIME = {METHOD: GET, ENDPOINT: f"/api/{REST_API_VERSION}/public/time"}
REST_MARK_PRICE = {METHOD: GET, ENDPOINT: f"/api/{REST_API_VERSION}/public/mark-price"}
REST_INDEX_TICKERS = {METHOD: GET, ENDPOINT: f"/api/{REST_API_VERSION}/market/index-tickers"}
REST_GET_INSTRUMENTS = {METHOD: GET, ENDPOINT: f"/api/{REST_API_VERSION}/public/instruments"}

# REST API Private General Endpoints
REST_GET_WALLET_BALANCE = {METHOD: GET, ENDPOINT: f"/api/{REST_API_VERSION}/account/balance"}
REST_SET_POSITION_MODE = {METHOD: POST, ENDPOINT: f"/api/{REST_API_VERSION}/account/set-position-mode"}

# REST API Private Pair Specific Endpoints
REST_SET_LEVERAGE = {METHOD: POST, ENDPOINT: f"/api/{REST_API_VERSION}/account/set-leverage"}
REST_FUNDING_RATE_INFO = {METHOD: GET, ENDPOINT: f"/api/{REST_API_VERSION}/public/funding-rate"}
REST_GET_POSITIONS = {METHOD: GET, ENDPOINT: f"/api/{REST_API_VERSION}/account/positions"}
REST_PLACE_ACTIVE_ORDER = {METHOD: POST, ENDPOINT: f"/api/{REST_API_VERSION}/trade/order"}
REST_CANCEL_ACTIVE_ORDER = {METHOD: POST, ENDPOINT: f"/api/{REST_API_VERSION}/trade/cancel-order"}
REST_QUERY_ACTIVE_ORDER = {METHOD: GET, ENDPOINT: REST_PLACE_ACTIVE_ORDER[ENDPOINT]}
REST_USER_TRADE_RECORDS = {METHOD: GET, ENDPOINT: f"/api/{REST_API_VERSION}/trade/fills"}
REST_BILLS_DETAILS = {METHOD: GET, ENDPOINT: f"/api/{REST_API_VERSION}/account/bills"}
REST_WS_LOGIN_PATH = {METHOD: GET, ENDPOINT: "/users/self/verify"}
