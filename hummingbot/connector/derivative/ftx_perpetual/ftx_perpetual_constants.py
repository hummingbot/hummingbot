...
RATE_LIMITS = [
    ...
    RateLimit(limit_id=FTX_PER_SECOND_ORDER_PERP_LIMIT_ID, limit=PER_SECOND_PERP_LIMIT, time_interval=1),
    RateLimit(limit_id=FTX_PER_MS_ORDER_PERP_LIMIT_ID, limit=PER_200_MS_PERP_LIMIT, time_interval=TWO_HUNDRED_MS),
