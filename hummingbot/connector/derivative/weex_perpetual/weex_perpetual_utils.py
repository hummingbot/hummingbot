...
# Weex fees: https://help.weex.com/hc/en-us/articles/360039261154
...
def get_next_funding_timestamp(current_timestamp: float) -> float:
    # On Weex Perpetuals, funding occurs every 8 hours at 00:00UTC, 08:00UTC and 16:00UTC.
    # Reference: https://help.weex.com/hc/en-us/articles/360039261134-Funding-fee-calculation
...
class WeexPerpetualConfigMap(BaseConnectorConfigMap):
    ...
    weex_perpetual_secret_key: SecretStr = Field(
        default=...,
        json_schema_extra={
...
OTHER_DOMAINS_DEFAULT_FEES = {
    "weex_perpetual_testnet": TradeFeeSchema(
...
class WeexPerpetualTestnetConfigMap(BaseConnectorConfigMap):
    ...
    weex_perpetual_testnet_secret_key: SecretStr = Field(
        default=...,
        json_schema_extra={
    ...
    model_config = ConfigDict(title="weex_perpetual_testnet")


OTHER_DOMAINS_KEYS = {
    "weex_perpetual_testnet": WeexPerpetualTestnetConfigMap.model_construct()
}
