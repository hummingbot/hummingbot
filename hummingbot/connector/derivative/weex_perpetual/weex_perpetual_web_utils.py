...
from hummingbot.connector.derivative.weex_perpetual import weex_perpetual_constants as CONSTANTS
from hummingbot.connector.derivative.weex_perpetual.weex_perpetual_utils import is_linear_perpetual
