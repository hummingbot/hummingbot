...
DEFAULT_DOMAIN = "weex_perpetual_main"

DEFAULT_TIME_IN_FORCE = "GTC"

REST_URLS = {
    "weex_perpetual_main": "https://api.weex.com/",
    "weex_perpetual_testnet": "https://api-testnet.weex.com/"
}
WSS_NON_LINEAR_PUBLIC_URLS = {
    "weex_perpetual_main": "wss://stream.weex.com/v5/public/inverse",
    "weex_perpetual_testnet": "wss://stream-testnet.weex.com/v5/public/inverse"}
WSS_NON_LINEAR_PRIVATE_URLS = WSS_NON_LINEAR_PUBLIC_URLS
WSS_LINEAR_PUBLIC_URLS = {
    "weex_perpetual_main": "wss://stream.weex.com/v5/public/linear",
    "weex_perpetual_testnet": "wss://stream-testnet.weex.com/v5/public/linear"}
WSS_LINEAR_PRIVATE_URLS = {
    "weex_perpetual_main": "wss://stream.weex.com/v5/private",
    "weex_perpetual_testnet": "wss://stream-testnet.weex.com/v5/private"
}
...
# https://weex-exchange.github.io/docs/v5/guide#parameters-for-authenticated-endpoints
