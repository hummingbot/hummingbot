...
from hummingbot.connector.derivative.weex_perpetual import (
    weex_perpetual_constants as CONSTANTS,
    weex_perpetual_utils,
    weex_perpetual_web_utils as web_utils,
)
...
if TYPE_CHECKING:
    from hummingbot.connector.derivative.weex_perpetual.weex_perpetual_derivative import WeexPerpetualDerivative


class WeexPerpetualAPIOrderBookDataSource(PerpetualAPIOrderBookDataSource):
    def __init__(
        self,
    ...
    async def listen_for_subscriptions(self):
        ...
        tasks_future = None
        try:
            linear_trading_pairs, non_linear_trading_pairs = weex_perpetual_utils.get_linear_non_linear_split(
                self._trading_pairs
            )
