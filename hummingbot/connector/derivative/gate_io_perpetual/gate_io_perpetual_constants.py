...
RATE_LIMITS = [
    ...
    RateLimit(
        limit_id=ORDER_DELETE_LIMIT_ID,
        limit=400,
        time_interval=1,
    ...
    RateLimit(
        limit_id=ONEWAY_SET_LEVERAGE_PATH_URL,
        limit=400,
        time_interval=1,
        linked_limits=[LinkedLimitWeightPair(PRIVATE_URL_POINTS_LIMIT_ID)],
    ),
    RateLimit(
        limit_id=HEDGE_SET_LEVERAGE_PATH_URL,
        limit=400,
        time_interval=1,
        linked_limits=[LinkedLimitWeightPair(PRIVATE_URL_POINTS_LIMIT_ID)],
    ),
    RateLimit(
        limit_id=USER_ORDERS_PATH_URL,
        limit=400,
        time_interval=1,
        linked_limits=[LinkedLimitWeightPair(PRIVATE_URL_POINTS_LIMIT_ID)],
    ),
    ...
    RateLimit(
        limit_id=FUNDING_RATE_TIME_PATH_URL,
        limit=300,
        time_interval=1,
        linked_limits=[LinkedLimitWeightPair(PUBLIC_URL_POINTS_LIMIT_ID)],
    ),
