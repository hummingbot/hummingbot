...
from hummingbot.connector.derivative.rubin_perpetual.rubin_perpetual_api_order_book_data_source import (
    RubinPerpetualAPIOrderBookDataSource,
)
...
class RubinPerpetualDerivative(PerpetualDerivativePyBase):
    web_utils = web_utils

    def __init__(
            self,
            rubin_perpetual_secret_phrase: str,
            rubin_perpetual_chain_address: str,
        ...
        self._rubin_perpetual_secret_phrase = rubin_perpetual_secret_phrase
        self._rubin_perpetual_chain_address = rubin_perpetual_chain_address
    ...
    async def _update_balances(self):
        path = f"{CONSTANTS.PATH_SUBACCOUNT}/{self._rubin_perpetual_chain_address}/subaccountNumber/{self.subaccount_id}"
    ...
    async def _request_order_fills(self, order: InFlightOrder) -> Dict[str, Any]:
        ...
        body_params = {
            'address': self._rubin_perpetual_chain_address,
    ...
    def _create_tx_client(self) -> RubinPerpetualV4Client:
    ...
    def _create_order_book_data_source(self) -> RubinPerpetualAPIOrderBookDataSource:
        return RubinPerpetualAPIOrderBookDataSource(
            self.trading_pairs,
            connector=self,
