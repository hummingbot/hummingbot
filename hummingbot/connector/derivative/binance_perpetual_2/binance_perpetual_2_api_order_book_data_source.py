...
if TYPE_CHECKING:
    from hummingbot.connector.derivative.binance_perpetual_2.binance_perpetual_2_derivative import (
        BinancePerpetual2Derivative,
    )


class BinancePerpetual2APIOrderBookDataSource(PerpetualAPIOrderBookDataSource):
    ...
    async def listen_for_order_book_snapshots(self, ev_loop: asyncio.BaseEventLoop, output: asyncio.Queue):
        while True:
            try:
                ...
                delta = CONSTANTS.ONE_HOUR if hasattr(CONSTANTS, "ONE_HOUR") else 3600
