...
OPEN_INTEREST_URL = "/api/v1/openInterest"
INSTRUMENTS_URL = "/api/v1/markets"
...
RATE_LIMITS = [
    ...
    RateLimit(limit_id=POSITIONS_URL, limit=10, time_interval=1),
    ...
    RateLimit(limit_id=PLACE_ORDER_URL, limit=10, time_interval=1),
    RateLimit(limit_id=CANCEL_ORDER_URL, limit=10, time_interval=1),
    RateLimit(limit_id=FILLS_URL, limit=10, time_interval=1),
    RateLimit(limit_id=FUNDING_RATES_URL, limit=10, time_interval=1),
    RateLimit(limit_id=INSTRUMENTS_URL, limit=10, time_interval=1),
]
