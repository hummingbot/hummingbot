...
class BackpackPerpetualDerivative(PerpetualDerivativePyBase):
    """
    Hummingbot connector for Backpack Perpetual futures exchange.
    """
    web_utils = web_utils
    ...
    def __init__(
        ...
        self._api_secret = backpack_perpetual_api_secret
            ...
            try:
                ...
                trading_rules.append(
                    TradingRule(
                        ...
                        min_notional_size=Decimal(str(instrument.get("minNotional", "10"))),
                    )
                )
            ...
            trade_updates.append(
                TradeUpdate(
                    ...
                    fee=TradeFeeBase.new_perpetual_fee(
                        ...
                        percent_token=fill.get("feeSymbol", "USDC"),
                        flat_fees=[TokenAmount(
                            token=fill.get("feeSymbol", "USDC"),
