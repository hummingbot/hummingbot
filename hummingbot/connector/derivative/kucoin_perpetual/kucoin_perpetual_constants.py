...
# v2 position mode endpoint (KuCoin v1 endpoint does not exist)
SWITCH_POSITION_MODE_PATH_URL = "api/v2/position/switchPositionMode"

RET_CODE_ORDER_NOT_EXISTS = "20001"
RET_CODE_ORDER_CANNOT_BE_CANCELED = "100004"
RET_CODE_MODE_POSITION_NOT_EMPTY = "30082"
RET_CODE_POSITION_MODE_ALREADY_SET = "300010"
