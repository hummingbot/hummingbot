...
from hummingbot.connector.derivative.bitget_unified_perpetual import (
    bitget_unified_perpetual_constants as CONSTANTS,
...
class BitgetUnifiedPerpetualAPIOrderBookDataSource(PerpetualAPIOrderBookDataSource):
    """
    Data source for retrieving order book data from
    the BitgetUnified Perpetual exchange via REST and WebSocket APIs.
    """
    ...
    def __init__(
        ...
        connector: 'BitgetUnifiedPerpetualDerivative',
