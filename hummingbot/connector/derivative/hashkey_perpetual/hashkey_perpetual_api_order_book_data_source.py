...
class HashkeyPerpetualAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def get_funding_info(self, trading_pair: str) -> FundingInfo:
        ...
        funding_info = FundingInfo(
            ...
            index_price=Decimal(index_info["index"]),
    ...
    async def _request_complete_funding_info(self, trading_pair: str):
        ...
        funding_rate_info, mark_info, index_info = await asyncio.gather(
            ...
            self._request_index_price(symbol),
        )
        return funding_rate_info, mark_info, index_info

    async def _request_funding_rate(self, symbol: str):
