...
class DydxPerpetualUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self, dydx_auth: DydxPerpetualAuth, api_factory: Optional[WebAssistantsFactory], connector):
    ...
    async def _connected_websocket_assistant(self) -> WSAssistant:
        if self._ws_assistant is None:
            ...
            subaccount_id = f"{self._connector._dydx_perpetual_chain_address}/{self._connector.subaccount_id}"
